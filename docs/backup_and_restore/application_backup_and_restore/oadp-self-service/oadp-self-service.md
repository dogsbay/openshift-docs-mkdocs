...
## About OADP Self-Service { #oadp-self-service-overview_oadp-self-service }
...
## What namespace-scoped backup and restore means { #oadp-self-service-overview-namespace-scope_oadp-self-service }
...
## OADP Self-Service custom resources { #oadp-self-service-custom-resources_oadp-self-service }
...
## How OADP Self-Service works { #oadp-self-service-how-it-works_oadp-self-service }
...
![OADP Self-Service](../../../images/oadp-self-service.svg)
...
## OADP Self-Service namespace permissions { #oadp-self-service-namespace-permissions_oadp-self-service }
...
### Example RBAC YAML for backup operation { #oadp-self-service-yaml-backup-operation_oadp-self-service }
...
## OADP Self-Service limitations { #oadp-self-service-unsupported-features_oadp-self-service }
...
## OADP Self-Service backup and restore phases { #oadp-self-service-phases_oadp-self-service }
...
## About NonAdminBackupStorageLocation CR { #oadp-self-service-about-nabsl_oadp-self-service }
