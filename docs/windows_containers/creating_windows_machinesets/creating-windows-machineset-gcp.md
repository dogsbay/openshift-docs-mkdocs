---
title: Creating a Windows machine set on Google Cloud
---

# Creating a Windows machine set on Google Cloud { #creating-windows-machineset-gcp }
...
## Sample YAML for a Windows MachineSet object on Google Cloud { #windows-machineset-gcp_creating-windows-machineset-gcp }
...
## Creating a compute machine set { #machineset-creating_creating-windows-machineset-gcp }
