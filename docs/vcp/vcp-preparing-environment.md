...
## Install KubeVirt Redfish { #proc_virt-installing-kubevirt-redfish_vcp-preparing-environment }
...
## Create control plane VMs { #proc_virt-creating-vcp-vms_vcp-preparing-environment }
