...
## Admin credentials root secret format { #admin-credentials-root-secret-formats_cco-mode-passthrough }
...
```yaml title="Red&#160;Hat OpenStack Platform (RHOSP) secret format"
apiVersion: v1
kind: Secret
metadata:
  namespace: kube-system
