...
## About configuring LDAP sync { #ldap-syncing-about_ldap-syncing-groups }
...
### LDAP client configuration { #ldap-client-configuration_ldap-syncing-groups }
...
### LDAP query definition { #ldap-query-definition_ldap-syncing-groups }
...
### User-defined name mapping { #user-defined-name-mapping_ldap-syncing-groups }
...
### About the RFC 2307 configuration file { #ldap-syncing-config-rfc2307_ldap-syncing-groups }
...
### About the Active Directory configuration file { #ldap-syncing-config-activedir_ldap-syncing-groups }
...
### About the augmented Active Directory configuration file { #ldap-syncing-config-augmented-activedir_ldap-syncing-groups }
...
## Automatically syncing LDAP groups { #ldap-auto-syncing_ldap-syncing-groups }
...
## LDAP group sync examples { #ldap-syncing-examples_ldap-syncing-groups }
...
#### Example LDAP entries { #example-ldap-entries_ldap-syncing-groups }
...
#### Configuration requirements { #configuration-requirements_ldap-syncing-groups }
...
#### Example sync configuration { #example-sync-configuration_ldap-syncing-groups }
...
### LDAP nested membership sync example { #ldap-syncing-nesting_ldap-syncing-groups }
...
## LDAP sync configuration specification { #ldap-syncing-spec_ldap-syncing-groups }
...
### v1.LDAPSyncConfig { #sync-ldap-v1-ldapsyncconfig_ldap-syncing-groups }
...
| `insecure`                 | If `true`, indicates the connection should not use TLS. If `false`, `ldaps://` URLs connect using TLS, and `ldap://` URLs are upgraded to a TLS connection using `StartTLS` as specified in [https://tools.ietf.org/html/rfc2830](https://tools.ietf.org/html/rfc2830). If you set `insecure` to `true`, you cannot use `ldaps://` URL schemes. | boolean                           |
...
### v1.StringSource { #sync-ldap-v1-stringsource_ldap-syncing-groups }
...
### v1.LDAPQuery { #sync-ldap-v1-ldapquery_ldap-syncing-groups }
...
### v1.RFC2307Config { #sync-ldap-v1-rfc2307config_ldap-syncing-groups }
...
### v1.ActiveDirectoryConfig { #sync-ldap-v1-activedirectoryconfig_ldap-syncing-groups }
...
### v1.AugmentedActiveDirectoryConfig { #sync-ldap-v1-augmentedactivedirectoryconfig_ldap-syncing-groups }
