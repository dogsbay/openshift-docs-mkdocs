...
## Image registry removed during installation { #registry-removed_configuring-registry-storage-nutanix }
...
## Changing the image registry’s management state { #registry-change-management-state_configuring-registry-storage-nutanix }
...
## Image registry storage configuration { #installation-registry-storage-config_configuring-registry-storage-nutanix }
...
### Configuring the Image Registry Operator to use Ceph RGW storage with Red Hat OpenShift Data Foundation { #registry-configuring-registry-storage-rhodf-cephrgw_configuring-registry-storage-nutanix }
...
### Configuring the Image Registry Operator to use Noobaa storage with Red Hat OpenShift Data Foundation { #registry-configuring-registry-storage-rhodf-nooba_configuring-registry-storage-nutanix }
...
## Configuring the Image Registry Operator to use CephFS storage with Red Hat OpenShift Data Foundation { #registry-configuring-registry-storage-rhodf-cephfs_configuring-registry-storage-nutanix }
