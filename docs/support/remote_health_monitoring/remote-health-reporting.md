...
## Enabling remote health reporting { #enabling-remote-health-reporting_remote-health-reporting }
...
## Changing your global cluster pull secret to enable remote health reporting { #insights-operator-new-pull-secret-enable_remote-health-reporting }
...
## Consequences of disabling remote health reporting { #telemetry-consequences-of-disabling-telemetry_remote-health-reporting }
...
## Disabling remote health reporting { #insights-operator-new-pull-secret_remote-health-reporting }
...
## Registering your disconnected cluster { #insights-operator-register-disconnected-cluster_remote-health-reporting }
