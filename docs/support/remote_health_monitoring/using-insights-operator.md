...
## The Insights Operator configuration { #insights-operator-configuring_using-insights-operator }
...
### ConfigMap object configuration structure { #insights-operator-configuring-configmap_using-insights-operator }
...
<tr>
  ...
  <td>Disables Insights Operator alerts to the cluster Prometheus instance.</td>
  <td>Boolean</td>
...
<tr>
  ...
  <td>Specifies the endpoint for downloading the latest Red&#160;Hat Lightspeed analysis.</td>
  <td>URL</td>
...
<tr>
  ...
  <td>Set custom proxy for Insights Operator.</td>
  <td>URL</td>
  <td>No default</td>
</tr>
<tr>
...
## Creating the insights-config ConfigMap object { #insights-operator-insights-config_using-insights-operator }
...
## Viewing Insights Operator alerts { #understanding-insights-operator-alerts_using-insights-operator }
...
### Enabling Insights Operator alerts { #enabling-insights-operator-alerts_using-insights-operator }
...
## Downloading your Insights Operator archive { #insights-operator-downloading-archive_using-insights-operator }
...
## On-demand Insights Operator gather operations { #running-insights-operator-gather_using-insights-operator }
...
### Viewing Insights Operator gather durations { #insights-operator-gather-duration_using-insights-operator }
...
### Gathering data on demand with the Insights Operator from the web console { #running-insights-operator-gather-web-console_using-insights-operator }
...
### Gathering data on demand with the Insights Operator from the OpenShift CLI { #running-insights-operator-gather-openshift-cli_using-insights-operator }
...
### Disabling the Insights Operator periodic gather operations { #disabling-insights-operator-gather_using-insights-operator }
...
### Re-enabling the Insights Operator periodic gather operations { #enabling-insights-operator-gather_using-insights-operator }
...
## Obfuscating Deployment Validation Operator data { #obfuscating-deployment-validation-operator-data_using-insights-operator }
