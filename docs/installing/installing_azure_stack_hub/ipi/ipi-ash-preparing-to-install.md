...
## Generating a key pair for cluster node SSH access { #ssh-agent-using_ash-preparing-to-install-ipi }
...
## Obtaining the installation program { #installation-obtaining-installer_ash-preparing-to-install-ipi }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_ash-preparing-to-install-ipi }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_ash-preparing-to-install-ipi }
...
## Telemetry access for OpenShift Container Platform { #cluster-telemetry_ash-preparing-to-install-ipi }
