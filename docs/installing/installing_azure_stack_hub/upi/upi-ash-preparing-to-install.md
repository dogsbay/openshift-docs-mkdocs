...
## Generating a key pair for cluster node SSH access { #ssh-agent-using_upi-ash-preparing-to-install }
...
## Obtaining the installation program { #installation-obtaining-installer_upi-ash-preparing-to-install }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_upi-ash-preparing-to-install }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_upi-ash-preparing-to-install }
