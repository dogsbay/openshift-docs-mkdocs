...
## Available installation configuration parameters for Azure Stack Hub { #installation-configuration-parameters_installation-config-parameters-ash }
...
### Required configuration parameters { #installation-configuration-parameters-required_installation-config-parameters-ash }
...
### Network configuration parameters { #installation-configuration-parameters-network_installation-config-parameters-ash }
...
### Optional configuration parameters { #installation-configuration-parameters-optional_installation-config-parameters-ash }
...
### Additional Azure Stack Hub configuration parameters { #installation-configuration-parameters-additional-azure-stack-hub_installation-config-parameters-ash }
...
<tr>
  ...
  <td>The URL of a storage blob in the Azure Stack environment that contains an RHCOS VHD.<br><br><strong>Value:</strong> String, for example, \https://vhdsa.blob.example.example.com/vhd/rhcos-410.84.202112040202-0-azurestack.x86_64.vhd</td>
</tr>
</tbody>
</table>
