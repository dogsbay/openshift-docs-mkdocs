...
## Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_upi-vsphere-preparing-to-install }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_upi-vsphere-preparing-to-install }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_upi-vsphere-preparing-to-install }
...
## Generating a key pair for cluster node SSH access { #ssh-agent-using_upi-vsphere-preparing-to-install }
...
## Preparing the user-provisioned infrastructure { #installation-infrastructure-user-infra_upi-vsphere-preparing-to-install }
...
### Example load balancer configuration for user-provisioned clusters { #installation-load-balancing-user-infra-example_upi-vsphere-preparing-to-install }
...
## Validating DNS resolution for user-provisioned infrastructure { #installation-user-provisioned-validating-dns_upi-vsphere-preparing-to-install }
