...
# Installing a cluster on vSphere with user-provisioned infrastructure { #installing-vsphere }
...
## Prerequisites { #prerequisites_installing-vsphere_installing-vsphere }
...
## VMware vSphere region and zone enablement { #installation-vsphere-regions-zones_installing-vsphere }
...
## Manually creating the installation configuration file { #installation-initializing-manual_installing-vsphere }
...
### Sample install-config.yaml file for a VMware vSphere cluster { #installation-vsphere-config-yaml_installing-vsphere }
...
### Configuring the cluster-wide proxy during installation { #installation-configure-proxy_installing-vsphere }
...
### Configuring regions and zones for a VMware vCenter { #configuring-vsphere-regions-zones_installing-vsphere }
...
## Installing RHCOS and starting the OpenShift Container Platform bootstrap process { #installation-vsphere-machines_installing-vsphere }
...
## Adding more compute machines to a cluster in vSphere { #machine-vsphere-machines_installing-vsphere }
...
## Disk partitioning { #installation-disk-partitioning_installing-vsphere }
...
## Waiting for the bootstrap process to complete { #installation-installing-bare-metal_installing-vsphere }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-vsphere }
...
## Approving the certificate signing requests for your machines { #installation-approve-csrs_installing-vsphere }
...
## Initial Operator configuration { #installation-operators-config_installing-vsphere }
...
### Image registry removed during installation { #registry-removed_installing-vsphere }
...
### Image registry storage configuration { #installation-registry-storage-config_installing-vsphere }
...
#### Configuring registry storage for VMware vSphere { #registry-configuring-storage-vsphere_installing-vsphere }
...
#### Configuring storage for the image registry in non-production clusters { #installation-registry-storage-non-production_installing-vsphere }
...
#### Configuring block registry storage for VMware vSphere { #installation-registry-storage-block-recreate-rollout_installing-vsphere }
...
## Completing installation on user-provisioned infrastructure { #installation-complete-user-infra_installing-vsphere }
...
## Configuring vSphere DRS anti-affinity rules for control plane nodes { #anti-affinity-vsphere_installing-vsphere }
...
## Telemetry access for OpenShift Container Platform { #cluster-telemetry_installing-vsphere }
