...
# Expanding the cluster { #bare-metal-expanding-the-cluster }
...
## Preparing the bare-metal node { #preparing-the-bare-metal-node_bare-metal-expanding }
...
## Replacing a bare-metal control plane node { #replacing-a-bare-metal-control-plane-node_bare-metal-expanding }
...
## Preparing to deploy with Virtual Media on the `bare-metal` network { #preparing-to-deploy-with-virtual-media-on-the-baremetal-network_bare-metal-expanding }
...
## Diagnosing a duplicate MAC address when provisioning a new host in the cluster { #ipi-install-diagnosing-duplicate-mac-address_bare-metal-expanding }
...
## Provisioning the bare-metal node { #provisioning-the-bare-metal-node_bare-metal-expanding }
