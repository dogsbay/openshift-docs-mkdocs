...
![Troubleshooting workflow when the `install-config.yaml` file has errors or the Red&#160;Hat Enterprise Linux CoreOS (RHCOS) images are inaccessible](../../../images/flow1.png)
