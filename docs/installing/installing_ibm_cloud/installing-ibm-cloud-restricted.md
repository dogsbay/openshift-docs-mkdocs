...
In OpenShift Container Platform 4.22, you can install a cluster in a restricted network by creating an internal mirror of the installation release content that is accessible to an existing Virtual Private Cloud (VPC) on IBM Cloud(R).

## Prerequisites for installing a cluster on IBM Cloud(R) in a disconnected environment { #prereqs-ibm-cloud-restricted_installing-ibm-cloud-restricted }

Before installing an OpenShift Container Platform cluster on IBM Cloud(R) in a disconnected environment, ensure that you have configured your IBM Cloud(R) account, a mirror registry, an existing VPC with access to the mirror registry, and the `ccoctl` utility.
...
- You have an existing Virtual Private Cloud (VPC) on IBM Cloud(R) that meets the following requirements:
    ...
    - The VPC can access IBM Cloud(R) service endpoints using a public endpoint. If network restrictions limit access to public service endpoints, evaluate those services for alternate endpoints that might be available.
...
- [Configuring IAM for IBM Cloud(R)](configuring-iam-ibm-cloud.md#configuring-iam-ibm-cloud)

## About installations in restricted networks { #installation-about-restricted-networks_installing-ibm-cloud-restricted }
...
### Required internet access and an installation host { #required-internet-access-and-an-installation-host_installing-ibm-cloud-restricted }
...
### Access to a mirror registry { #access-to-a-mirror-registry_installing-ibm-cloud-restricted }
...
### Access to IBM service endpoints { #access-to-ibm-service-endpoints_installing-ibm-cloud-restricted }

The installation program requires access to the following IBM Cloud(R) service endpoints:
...
### Additional limits { #installation-restricted-network-limits_installing-ibm-cloud-restricted }
...
## About using a custom VPC { #installation-custom-ibm-cloud-vpc_installing-ibm-cloud-restricted }

You can deploy OpenShift Container Platform into the subnets of an existing IBM(R) Virtual Private Cloud (VPC) to avoid account limit constraints or comply with your company’s infrastructure guidelines.
...
### Requirements for using your VPC { #installation-custom-ibm-cloud-vpc-requirements_installing-ibm-cloud-restricted }
...
### VPC validation { #installation-custom-ibm-cloud-vpc-validation_installing-ibm-cloud-restricted }
...
### Isolation between clusters { #installation-custom-ibm-cloud-vpc-isolation_installing-ibm-cloud-restricted }
...
### Allowing endpoint gateway traffic { #installation-ibm-cloud-configure-vpc-for-endpoint-gateways_installing-ibm-cloud-restricted }

If you are using IBM Cloud(R) Virtual Private endpoints, your Virtual Private Cloud (VPC) must be configured to allow traffic to and from the endpoint gateways.
...
## Exporting the API key { #installation-ibm-cloud-export-variables_installing-ibm-cloud-restricted }
...
## Manually creating the installation configuration file { #installation-initializing-manual_installing-ibm-cloud-restricted }
...
### Configuring the cluster-wide proxy during installation { #installation-configure-proxy_installing-ibm-cloud-restricted }
...
- [Installation configuration parameters for IBM Cloud(R)](installation-config-parameters-ibm-cloud-vpc.md#installation-config-parameters-ibm-cloud-vpc)

### Minimum resource requirements for cluster installation { #installation-minimum-resource-requirements_installing-ibm-cloud-restricted }
...
### Tested instance types for IBM Cloud { #installation-ibm-cloud-tested-machine-types_installing-ibm-cloud-restricted }
...
:   Specifies the IBM Cloud(R) region to deploy the cluster to. This value is required.
...
## Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_installing-ibm-cloud-restricted }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_installing-ibm-cloud-restricted }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_installing-ibm-cloud-restricted }
...
## Manually creating IAM { #manually-create-iam-ibm-cloud_installing-ibm-cloud-restricted }
...
## Deploying the cluster { #installation-launching-installer_installing-ibm-cloud-restricted }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-ibm-cloud-restricted }
