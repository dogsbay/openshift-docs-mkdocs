---
title: Installing a private cluster on IBM Cloud
---

# Installing a private cluster on IBM Cloud { #installing-ibm-cloud-private }

In OpenShift Container Platform version 4.22, you can install a private cluster into an existing Virtual Private Cloud (VPC) on IBM Cloud(R). The installation program provisions the rest of the required infrastructure, which you can further customize.

## Prerequisites for installing a cluster on IBM Cloud(R) { #prereqs-ibm-cloud-installer-provisioned_installing-ibm-cloud-private }
...
## Private clusters { #private-clusters-default_installing-ibm-cloud-private }
...
## Private clusters in IBM Cloud { #private-clusters-about-ibm-cloud_installing-ibm-cloud-private }

To create a private cluster on IBM Cloud(R), you must provide an existing private VPC and subnets. The installation program must also resolve the DNS records that the cluster requires, and configures the Ingress Operator and API server for only internal traffic.
...
### Limitations { #private-clusters-limitations-ibm-cloud_installing-ibm-cloud-private }

Private clusters on IBM Cloud(R) are subject only to the limitations associated with the existing VPC that was used for cluster deployment.

## About using a custom VPC { #installation-custom-ibm-cloud-vpc_installing-ibm-cloud-private }
...
### Requirements for using your VPC { #installation-custom-ibm-cloud-vpc-requirements_installing-ibm-cloud-private }
...
### VPC validation { #installation-custom-ibm-cloud-vpc-validation_installing-ibm-cloud-private }
...
### Isolation between clusters { #installation-custom-ibm-cloud-vpc-isolation_installing-ibm-cloud-private }
...
## Internet access for OpenShift Container Platform { #cluster-entitlements_installing-ibm-cloud-private }
...
## Generating a key pair for cluster node SSH access { #ssh-agent-using_installing-ibm-cloud-private }
...
## Exporting the API key { #installation-ibm-cloud-export-variables_installing-ibm-cloud-private }
...
## Manually creating the installation configuration file { #installation-initializing-manual_installing-ibm-cloud-private }
...
### Minimum resource requirements for cluster installation { #installation-minimum-resource-requirements_installing-ibm-cloud-private }
...
### Tested instance types for IBM Cloud { #installation-ibm-cloud-tested-machine-types_installing-ibm-cloud-private }
...
### Sample customized install-config.yaml file for IBM Cloud { #installation-ibm-cloud-config-yaml_installing-ibm-cloud-private }
...
### Configuring the cluster-wide proxy during installation { #installation-configure-proxy_installing-ibm-cloud-private }
...
## Manually creating IAM { #manually-create-iam-ibm-cloud_installing-ibm-cloud-private }
...
## Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_installing-ibm-cloud-private }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_installing-ibm-cloud-private }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_installing-ibm-cloud-private }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-ibm-cloud-private }
...
## Telemetry access for OpenShift Container Platform { #cluster-telemetry_installing-ibm-cloud-private }
