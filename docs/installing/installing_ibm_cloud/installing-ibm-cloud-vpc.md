---
title: Installing a cluster on IBM Cloud into an existing VPC
---

# Installing a cluster on IBM Cloud into an existing VPC { #installing-ibm-cloud-vpc }

In OpenShift Container Platform version 4.22, you can install a cluster into an existing Virtual Private Cloud (VPC) on IBM Cloud(R). The installation program provisions the rest of the required infrastructure, which you can further customize.

## Prerequisites for installing a cluster on IBM Cloud(R) { #prereqs-ibm-cloud-installer-provisioned_installing-ibm-cloud-vpc }
...
## About using a custom VPC { #installation-custom-ibm-cloud-vpc_installing-ibm-cloud-vpc }
...
### Requirements for using your VPC { #installation-custom-ibm-cloud-vpc-requirements_installing-ibm-cloud-vpc }
...
### VPC validation { #installation-custom-ibm-cloud-vpc-validation_installing-ibm-cloud-vpc }
...
### Isolation between clusters { #installation-custom-ibm-cloud-vpc-isolation_installing-ibm-cloud-vpc }
...
## Internet access for OpenShift Container Platform { #cluster-entitlements_installing-ibm-cloud-vpc }
...
## Generating a key pair for cluster node SSH access { #ssh-agent-using_installing-ibm-cloud-vpc }
...
## Obtaining the installation program { #installation-obtaining-installer_installing-ibm-cloud-vpc }
...
## Exporting the API key { #installation-ibm-cloud-export-variables_installing-ibm-cloud-vpc }
...
## Creating the installation configuration file { #installation-initializing_installing-ibm-cloud-vpc }
...
### Minimum resource requirements for cluster installation { #installation-minimum-resource-requirements_installing-ibm-cloud-vpc }
...
### Tested instance types for IBM Cloud { #installation-ibm-cloud-tested-machine-types_installing-ibm-cloud-vpc }
...
### Sample customized install-config.yaml file for IBM Cloud { #installation-ibm-cloud-config-yaml_installing-ibm-cloud-vpc }
...
### Configuring the cluster-wide proxy during installation { #installation-configure-proxy_installing-ibm-cloud-vpc }
...
## Manually creating IAM { #manually-create-iam-ibm-cloud_installing-ibm-cloud-vpc }
...
## Deploying the cluster { #installation-launching-installer_installing-ibm-cloud-vpc }
...
## Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_installing-ibm-cloud-vpc }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_installing-ibm-cloud-vpc }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_installing-ibm-cloud-vpc }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-ibm-cloud-vpc }
...
## Telemetry access for OpenShift Container Platform { #cluster-telemetry_installing-ibm-cloud-vpc }
