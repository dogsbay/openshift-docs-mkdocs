...
# Installing a cluster { #installing-with-agent-basic }
...
## Prerequisites for installing a cluster with the Agent-based Installer { #prerequisites_installing-with-agent-basic }
...
## Creating the configuration inputs { #installing-ocp-agent-basic-inputs_installing-with-agent-basic }
...
## Verifying that the current installation host can pull release images { #installing-ocp-agent-tui_installing-with-agent-basic }
