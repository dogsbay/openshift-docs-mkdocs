...
# Installing a cluster without an external registry { #installing-ove }
...
## Installation method advantages { #virt-installing-ove-advantages_installing-ove }
...
## Downloading the installation ISO { #virt-installing-ove-iso_installing-ove }
...
## Mounting the ISO and booting the rendezvous node { #virt-installing-ove-booting_installing-ove }
...
5. Wait for the rendezvous node to provide a URL for finishing the installation and save the URL for later use, as shown in the following image. ![The rendezvous host providing the URL of the installation console](../../images/installing-ove-console.png)
...
## Booting the remaining cluster hosts { #virt-installing-ove-hosts_installing-ove }
...
## Completing cluster configuration and initiating the installation { #virt-installing-ove-console-final_installing-ove }
...
- [Installing virtctl](../../virt/getting_started/virt-using-the-cli-tools.md#virt-installing-virtctl-binary_virt-using-the-cli-tools)
- [Creating virtual machines from instance types](../../virt/creating_vm/virt-creating-vms-from-instance-types.md#virt-creating-vms-from-instance-types)
- [Creating virtual machines from templates](../../virt/creating_vm/virt-creating-vms-from-templates.md#virt-creating-vms-from-templates)
