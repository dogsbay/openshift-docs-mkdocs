...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_upi-ibm-z-preparing-to-install }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_upi-ibm-z-preparing-to-install }
...
## Generating a key pair for cluster node SSH access { #ssh-agent-using_upi-ibm-z-preparing-to-install }
...
## Validating DNS resolution for user-provisioned infrastructure { #installation-user-provisioned-validating-dns_upi-ibm-z-preparing-to-install }
