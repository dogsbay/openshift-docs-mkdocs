...
<tr>
  ...
  <td>20 per region</td>
  <td>This is an optional component. To use spot VMs, you must increase the Azure default limit to at least twice the number of compute nodes in your cluster.<div class="admonition note"><p class="admonition-title">Note</p><p>Using spot VMs for control plane nodes is not recommended.</p></div></td>
</tr>
</tbody>
</table>
...
??? note "Required permissions for creating authorization resources"
...
??? note "Required permissions for creating identity management resources"
...
??? note "Required permissions for checking the health of resources"
...
??? note "Required permissions for creating a resource group"

    - `Microsoft.Resources/subscriptions/resourceGroups/read`
    - `Microsoft.Resources/subscriptions/resourcegroups/write`

??? note "Required permissions for creating resource tags"

    - `Microsoft.Resources/tags/write`

??? note "Required permissions for creating storage resources"
...
??? note "Required permissions for creating deployments"
...
??? note "Optional permissions for creating compute resources"

    - `Microsoft.Compute/availabilitySets/delete`
    - `Microsoft.Compute/availabilitySets/write`

??? note "Optional permissions for creating marketplace virtual machine resources"

    - `Microsoft.MarketplaceOrdering/offertypes/publishers/offers/plans/agreements/read`
    - `Microsoft.MarketplaceOrdering/offertypes/publishers/offers/plans/agreements/write`

??? note "Optional permissions for enabling user-managed encryption"
...
??? note "Required permissions for deleting authorization resources"
...
??? note "Required permissions for deleting identity management resources"
...
??? note "Required permissions for deleting a resource group"

    - `Microsoft.Resources/subscriptions/resourcegroups/delete`

??? note "Required permissions for deleting storage resources"
