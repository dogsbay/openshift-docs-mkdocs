...
## Private clusters { #private-clusters-default_installing-azure-private }
...
### Private clusters in Azure { #private-clusters-about-azure_installing-azure-private }
...
#### Limitations { #private-clusters-limitations-azure_installing-azure-private }

Private clusters on Azure are subject to only the limitations that are associated with the use of an existing VNet.

### User-defined outbound routing { #installation-azure-user-defined-routing_installing-azure-private }
...
#### Private cluster with network address translation { #private-cluster-with-network-address-translation_installing-azure-private }
...
#### Private cluster with Azure Firewall { #private-cluster-with-azure-firewall_installing-azure-private }
...
#### Private cluster with a proxy configuration { #private-cluster-with-proxy-configuration_installing-azure-private }
...
#### Private cluster with no internet access { #private-cluster-with-no-internet-access_installing-azure-private }
...
## About reusing a VNet for your OpenShift Container Platform cluster { #installation-about-custom-azure-vnet_installing-azure-private }
...
### Requirements for using your VNet { #installation-about-custom-azure-vnet-requirements_installing-azure-private }
...
#### Network security group requirements { #installation-about-custom-azure-vnet-nsg-requirements_installing-azure-private }
...
### Division of permissions { #installation-about-custom-azure-permissions_installing-azure-private }
...
### Isolation between clusters { #installation-about-custom-azure-vnet-isolation_installing-azure-private }
...
## Manually creating the installation configuration file { #installation-initializing-manual_installing-azure-private }
...
### Minimum resource requirements for cluster installation { #installation-minimum-resource-requirements_installing-azure-private }
...
### Tested instance types for Azure { #installation-azure-tested-machine-types_installing-azure-private }
...
### Tested instance types for Azure on 64-bit ARM infrastructures { #installation-azure-arm-tested-machine-types_installing-azure-private }
...
### Enabling trusted launch for Azure VMs { #installation-azure-trusted-launch_installing-azure-private }
...
### Enabling confidential VMs { #installation-azure-confidential-vms_installing-azure-private }
...
### Enabling a user-managed DNS { #installation-azure-enabling-user-managed-DNS_installing-azure-private }
...
### Sample customized install-config.yaml file for Azure { #installation-azure-config-yaml-simple_installing-azure-private }
...
### Configuring the cluster-wide proxy during installation { #installation-configure-proxy_installing-azure-private }
...
#### Configuring the Cloud Credential Operator utility { #cco-ccoctl-configuring_installing-azure-private }
...
## Optional: Preparing a private Microsoft Azure cluster for a private image registry { #installing-private-image-registry-private-azure }
...
## Provisioning your own DNS records { #installation-azure-provisioning-own-dns-records_installing-azure-private }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-azure-private }
