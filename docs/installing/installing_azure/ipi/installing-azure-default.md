...
# Installing a cluster on Azure { #installing-azure-default }
...
## Deploying the cluster { #installation-launching-installer_installing-azure-default }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-azure-default }
