...
## About reusing a VNet for your OpenShift Container Platform cluster { #installation-about-custom-azure-vnet_installing-azure-vnet }
...
### Requirements for using your VNet { #installation-about-custom-azure-vnet-requirements_installing-azure-vnet }
...
#### Network security group requirements { #installation-about-custom-azure-vnet-nsg-requirements_installing-azure-vnet }
...
### Division of permissions { #installation-about-custom-azure-permissions_installing-azure-vnet }
...
### Isolation between clusters { #installation-about-custom-azure-vnet-isolation_installing-azure-vnet }
...
## Creating the installation configuration file { #installation-initializing_installing-azure-vnet }
...
### Minimum resource requirements for cluster installation { #installation-minimum-resource-requirements_installing-azure-vnet }
...
### Tested instance types for Azure { #installation-azure-tested-machine-types_installing-azure-vnet }
...
### Tested instance types for Azure on 64-bit ARM infrastructures { #installation-azure-arm-tested-machine-types_installing-azure-vnet }
...
### Enabling trusted launch for Azure VMs { #installation-azure-trusted-launch_installing-azure-vnet }
...
### Sample customized install-config.yaml file for Azure { #installation-azure-config-yaml-simple_installing-azure-vnet }
...
### Configuring the cluster-wide proxy during installation { #installation-configure-proxy_installing-azure-vnet }
...
## Alternatives to storing administrator-level secrets in the kube-system project { #installing-azure-manual-modes_installing-azure-vnet }
...
### Manually creating long-term credentials { #manually-create-iam_installing-azure-vnet }
...
### Configuring an Azure cluster to use short-term credentials { #installing-azure-with-short-term-creds_installing-azure-vnet }
...
#### Configuring the Cloud Credential Operator utility { #cco-ccoctl-configuring_installing-azure-vnet }
...
#### Incorporating the Cloud Credential Operator utility manifests { #cco-ccoctl-install-creating-manifests_installing-azure-vnet }
...
## Deploying the cluster { #installation-launching-installer_installing-azure-vnet }
