...
## Configuring Route 53 { #installation-aws-route53_installing-aws-account }
...
### Ingress Operator endpoint configuration for AWS Route 53 { #nw-endpoint-route53_installing-aws-account }
...
## AWS account limits { #installation-aws-limits_installing-aws-account }
...
<tr>
  ...
  <td>Because the installation process creates a temporary bucket and the registry component in each cluster creates a bucket, you can create only 99 OpenShift Container Platform clusters per AWS account.</td>
</tr>
<tr>
...
## Required AWS permissions for the IAM user { #installation-aws-permissions_installing-aws-account }
...
## Creating an IAM user { #installation-aws-iam-user_installing-aws-account }
...
## IAM Policies and AWS authentication { #iam-policies-and-aws-authentication_installing-aws-account }
...
### Default permissions for IAM instance profiles { #installation-aws-permissions-iam-roles_installing-aws-account }
...
### Specifying an existing IAM role { #specify-an-existing-iam-role_installing-aws-account }
...
### Using AWS IAM Analyzer to create policy templates { #create-custom-permissions-for-iam-instance-profiles_installing-aws-account }
...
## Supported AWS Marketplace regions { #installation-aws-marketplace_installing-aws-account }
...
## Supported AWS regions { #installation-aws-regions_installing-aws-account }
...
### AWS public regions { #installation-aws-public_installing-aws-account }
...
### AWS EUSC region { #installation-aws-eusc_region_installing-aws-account }
...
### AWS GovCloud regions { #installation-aws-govcloud_installing-aws-account }
...
### AWS SC2S and C2S secret regions { #installation-aws-c2s_installing-aws-account }
...
### AWS China regions { #installation-aws-china_installing-aws-account }
