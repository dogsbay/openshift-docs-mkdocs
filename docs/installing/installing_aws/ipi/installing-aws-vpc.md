...
# Installing a cluster on AWS into an existing VPC { #installing-aws-vpc }
...
## Prerequisites { #prerequisites_installing-aws-vpc }
...
## About using a custom VPC { #installation-custom-aws-vpc_installing-aws-vpc }
...
### Option 1: Create VPC endpoints { #create-vpc-endpoints_installing-aws-vpc }
...
### Option 2: Create a proxy without VPC endpoints { #create-proxy-without-vpc-endpoints_installing-aws-vpc }
...
### Option 3: Create a proxy with VPC endpoints { #create-proxy-with-vpc-endpoints_installing-aws-vpc }
...
### VPC validation { #installation-custom-aws-vpc-validation_installing-aws-vpc }
...
### Division of permissions { #installation-about-custom-aws-permissions_installing-aws-vpc }
...
### Isolation between clusters { #installation-custom-aws-vpc-isolation_installing-aws-vpc }
...
### Optional: AWS security groups { #installation-aws-security-groups_installing-aws-vpc }
...
### Modifying trust policy when installing into a shared VPC { #installation-aws-permissions-iam-shared-vpc_installing-aws-vpc }
...
??? note "Required actions for shared VPC installation"
...
## Creating the installation configuration file { #installation-initializing_installing-aws-vpc }
...
### Minimum resource requirements for cluster installation { #installation-minimum-resource-requirements_installing-aws-vpc }
...
### Tested instance types for AWS { #installation-aws-tested-machine-types_installing-aws-vpc }
...
### Tested instance types for AWS on 64-bit ARM infrastructures { #installation-aws-arm-tested-machine-types_installing-aws-vpc }
...
### Enabling a user-managed DNS { #installation-aws-enabling-user-managed-DNS_installing-aws-vpc }
...
### Sample customized install-config.yaml file for AWS { #installation-aws-config-yaml-customizations_installing-aws-vpc }
...
### Configuring the cluster-wide proxy during installation { #installation-configure-proxy_installing-aws-vpc }
...
### Applying existing Amazon Web Services (AWS) security groups to the cluster { #installation-aws-vpc-security-groups_installing-aws-vpc }
...
### Allocating load balancers to specific subnets { #allocating-load-balancers_installing-aws-vpc }
...
#### Allocating API and Ingress load balancers to specific subnets on AWS { #nw-allocating-load-balancers-to-subnets_installing-aws-vpc }
...
#### Specifying AWS subnets for OpenShift API and ingress load balancers at installation { #nw-allocating-load-balancers-to-subnets-procedure_installing-aws-vpc }
...
## Alternatives to storing administrator-level secrets in the kube-system project { #installing-aws-manual-modes_installing-aws-vpc }
...
### Manually creating long-term credentials { #manually-create-iam_installing-aws-vpc }
...
### Configuring an AWS cluster to use short-term credentials { #installing-aws-with-short-term-creds_installing-aws-vpc }
...
#### Configuring the Cloud Credential Operator utility { #cco-ccoctl-configuring_installing-aws-vpc }
...
#### Creating AWS resources with a single command { #cco-ccoctl-creating-at-once_installing-aws-vpc }
...
#### Creating AWS resources individually { #cco-ccoctl-creating-individually_installing-aws-vpc }
...
#### Incorporating the Cloud Credential Operator utility manifests { #cco-ccoctl-install-creating-manifests_installing-aws-vpc }
...
## Deploying the cluster { #installation-launching-installer_installing-aws-vpc }
...
## Provisioning your own DNS records { #installation-aws-provisioning-own-dns-records_installing-aws-vpc }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-aws-vpc }
...
## Logging in to the cluster by using the web console { #logging-in-by-using-the-web-console_installing-aws-vpc }
