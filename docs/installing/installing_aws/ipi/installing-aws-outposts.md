...
## Obtaining information about your environment { #aws-outposts-environment-info_installing-aws-outposts }
...
### Obtaining information from your OpenShift Container Platform cluster { #aws-outposts-environment-info-oc_installing-aws-outposts }
...
### Obtaining information from your AWS account { #aws-outposts-environment-info-aws_installing-aws-outposts }
...
## Configuring your network for your Outpost { #aws-outposts-network-config_installing-aws-outposts }
...
### Changing the cluster network MTU to support AWS Outposts { #_changing_the_cluster_network_mtu_to_support_aws_outposts }
...
### Prerequisites for changing the cluster network MTU { #nw-cluster-mtu-change-prerequisites_installing-aws-outposts }
...
### Creating subnets for AWS edge compute services { #installation-creating-aws-vpc-subnets-edge_installing-aws-outposts }
...
### CloudFormation template for the VPC subnet { #installation-cloudformation-subnet-localzone_installing-aws-outposts }
...
## Creating a compute machine set that deploys edge compute machines on an Outpost { #aws-outposts-machine-set_installing-aws-outposts }
...
## Creating user workloads in an Outpost { #create-user-workloads-aws-edge_installing-aws-outposts }
...
1. Configure a `Deployment` resource file for an application that you want to deploy to the edge compute node in the edge subnet.
    ...
    ```yaml title="Example Deployment manifest"
    kind: Namespace
    apiVersion: v1
    metadata:
...
3. Configure a `Service` object that exposes a pod from a targeted edge compute node to services that run inside your edge network.
    ...
    ```yaml title="Example Service manifest"
    apiVersion: v1
    kind: Service
    metadata:
      name:  <application_name>
...
## Scheduling workloads on edge and cloud-based AWS compute resources { #aws-outposts-network-scheduling-workloads_installing-aws-outposts }
...
### Using Amazon Web Services (AWS) Classic Load Balancers in an AWS VPC cluster extended into an Outpost { #aws-outposts-load-balancer-clb_installing-aws-outposts }
