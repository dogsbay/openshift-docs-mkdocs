...
## Obtaining the installation program { #installation-obtaining-installer_ipi-aws-preparing-to-install }
...
## Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_ipi-aws-preparing-to-install }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_ipi-aws-preparing-to-install }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_ipi-aws-preparing-to-install }
...
## Generating a key pair for cluster node SSH access { #ssh-agent-using_ipi-aws-preparing-to-install }
...
## Telemetry access for OpenShift Container Platform { #cluster-telemetry_ipi-aws-preparing-to-install }
