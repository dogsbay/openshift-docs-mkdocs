...
# Installing a private cluster on AWS { #installing-aws-private }
...
## Prerequisites { #prerequisites_installing-aws-private }
...
## Private clusters { #private-clusters-default_installing-aws-private }
...
### Private clusters in AWS { #private-clusters-about-aws_installing-aws-private }
...
#### Limitations { #private-clusters-limitations-aws_installing-aws-private }
...
## About using a custom VPC { #installation-custom-aws-vpc_installing-aws-private }
...
### Option 1: Create VPC endpoints { #create-vpc-endpoints_installing-aws-private }
...
### Option 2: Create a proxy without VPC endpoints { #create-proxy-without-vpc-endpoints_installing-aws-private }
...
### Option 3: Create a proxy with VPC endpoints { #create-proxy-with-vpc-endpoints_installing-aws-private }
...
### VPC validation { #installation-custom-aws-vpc-validation_installing-aws-private }
...
### Division of permissions { #installation-about-custom-aws-permissions_installing-aws-private }
...
### Isolation between clusters { #installation-custom-aws-vpc-isolation_installing-aws-private }
...
### Optional: AWS security groups { #installation-aws-security-groups_installing-aws-private }
...
## Manually creating the installation configuration file { #installation-initializing-manual_installing-aws-private }
...
### Minimum resource requirements for cluster installation { #installation-minimum-resource-requirements_installing-aws-private }
...
### Tested instance types for AWS { #installation-aws-tested-machine-types_installing-aws-private }
...
### Tested instance types for AWS on 64-bit ARM infrastructures { #installation-aws-arm-tested-machine-types_installing-aws-private }
...
### Enabling a user-managed DNS { #installation-aws-enabling-user-managed-DNS_installing-aws-private }
...
### Sample customized install-config.yaml file for AWS { #installation-aws-config-yaml-customizations_installing-aws-private }
...
### Configuring the cluster-wide proxy during installation { #installation-configure-proxy_installing-aws-private }
...
### Applying existing Amazon Web Services (AWS) security groups to the cluster { #installation-aws-vpc-security-groups_installing-aws-private }
...
## Alternatives to storing administrator-level secrets in the kube-system project { #installing-aws-manual-modes_installing-aws-private }
...
### Configuring an AWS cluster to use short-term credentials { #installing-aws-with-short-term-creds_installing-aws-private }
...
#### Configuring the Cloud Credential Operator utility { #cco-ccoctl-configuring_installing-aws-private }
...
#### Creating AWS resources with a single command { #cco-ccoctl-creating-at-once_installing-aws-private }
...
#### Creating AWS resources individually { #cco-ccoctl-creating-individually_installing-aws-private }
...
## Provisioning your own DNS records { #installation-aws-provisioning-own-dns-records_installing-aws-private }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-aws-private }
...
## Logging in to the cluster by using the web console { #logging-in-by-using-the-web-console_installing-aws-private }
