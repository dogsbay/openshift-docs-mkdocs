...
## Removing a cluster that uses installer-provisioned infrastructure { #installation-uninstall-clouds_uninstall-cluster-aws }
...
## Deleting Amazon Web Services resources with the Cloud Credential Operator utility { #cco-ccoctl-deleting-sts-resources_uninstall-cluster-aws }
