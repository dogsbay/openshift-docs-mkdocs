...
## Internet access for OpenShift Container Platform { #cluster-entitlements_upi-aws-preparing-to-install }
...
## Obtaining the installation program { #installation-obtaining-installer_upi-aws-preparing-to-install }
...
## Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_upi-aws-preparing-to-install }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_upi-aws-preparing-to-install }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_upi-aws-preparing-to-install }
...
## Generating a key pair for cluster node SSH access { #ssh-agent-using_upi-aws-preparing-to-install }
...
## Telemetry access for OpenShift Container Platform { #cluster-telemetry_upi-aws-preparing-to-install }
