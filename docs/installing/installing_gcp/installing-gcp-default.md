...
## Generating a key pair for cluster node SSH access { #ssh-agent-using_installing-gcp-default }
...
## Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_installing-gcp-default }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_installing-gcp-default }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_installing-gcp-default }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-gcp-default }
