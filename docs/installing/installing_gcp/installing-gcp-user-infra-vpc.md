...
## Internet access for OpenShift Container Platform { #cluster-entitlements_installing-gcp-user-infra-vpc }
...
### Minimum resource requirements for cluster installation { #installation-minimum-resource-requirements_installing-gcp-user-infra-vpc }
...
## Creating the installation files for Google Cloud { #installation-user-infra-generate_installing-gcp-user-infra-vpc }
...
### Manually creating the installation configuration file { #installation-initializing-manual_installing-gcp-user-infra-vpc }
...
### Sample customized `install-config.yaml` file for Google Cloud { #installation-gcp-user-infra-shared-vpc-config-yaml_installing-gcp-user-infra-vpc }
...
### Creating the Kubernetes manifest and Ignition config files { #installation-user-infra-generate-k8s-manifest-ignition_installing-gcp-user-infra-vpc }
...
## Networking requirements for user-provisioned infrastructure { #installation-network-user-infra_installing-gcp-user-infra-vpc }
...
### Network connectivity requirements { #installation-network-connectivity-user-infra_installing-gcp-user-infra-vpc }
...
## Creating load balancers in Google Cloud { #installation-creating-gcp-lb_installing-gcp-user-infra-vpc }
...
## Creating the bootstrap machine in Google Cloud { #installation-creating-gcp-bootstrap_installing-gcp-user-infra-vpc }
...
## Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_installing-gcp-user-infra-vpc }
...
## Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_installing-gcp-user-infra-vpc }
...
## Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_installing-gcp-user-infra-vpc }
...
## Logging in to the cluster by using the CLI { #cli-logging-in-kubeadmin_installing-gcp-user-infra-vpc }
...
## Approving the certificate signing requests for your machines { #installation-approve-csrs_installing-gcp-user-infra-vpc }
...
### Creating cluster-wide firewall rules for a shared VPC in Google Cloud { #installation-creating-gcp-shared-vpc-cluster-wide-firewall-rules_installing-gcp-user-infra-vpc }
...
## Telemetry access for OpenShift Container Platform { #cluster-telemetry_installing-gcp-user-infra-vpc }
