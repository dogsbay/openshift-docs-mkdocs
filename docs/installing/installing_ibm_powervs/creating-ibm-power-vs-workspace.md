...
- [Installing a cluster on IBM Power(R) Virtual Server with customizations](installing-ibm-power-vs-customizations.md#installing-ibm-power-vs-customizations)
