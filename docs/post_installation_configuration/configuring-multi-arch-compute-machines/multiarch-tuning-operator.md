...
# Managing workloads on multi-architecture clusters by using the Multiarch Tuning Operator { #multiarch-tuning-operator }
...
## Installing the Multiarch Tuning Operator by using the CLI { #multi-architecture-installing-using-cli_multiarch-tuning-operator }
...
## Installing the Multiarch Tuning Operator by using the web console { #multi-architecture-installing-using-web-console_multiarch-tuning-operator }
...
## The ClusterPodPlacementConfig object { #multi-architecture-creating-podplacement-config_multiarch-tuning-operator }
...
### Creating the ClusterPodPlacementConfig object by using the CLI { #multi-architecture-creating-podplacement-config-using-cli_multiarch-tuning-operator }
...
### Creating the ClusterPodPlacementConfig object by using the web console { #multi-architecture-creating-podplacement-config-using-web-console_multiarch-tuning-operator }
...
## Creating the namespace-scoped PodPlacementConfig object { #multi-arch-creating-namespace-podplacement-config_multiarch-tuning-operator }
...
1. Using a text editor, create a YAML file based on the following example and modify the example with your namespace values:
    ...
    ```yaml title="Example PodPlacementConfig object configuration"
    apiVersion: multiarch.openshift.io/v1beta1
...
## Deleting the ClusterPodPlacementConfig object by using the CLI { #multi-architecture-deleting-podplacement-config-using-cli_multiarch-tuning-operator }
...
## Deleting the ClusterPodPlacementConfig object by using the web console { #multi-architecture-deleting-podplacement-config-using-web-console_multiarch-tuning-operator }
...
## Uninstalling the Multiarch Tuning Operator by using the CLI { #multi-architecture-uninstalling-using-cli_multiarch-tuning-operator }
...
## Uninstalling the Multiarch Tuning Operator by using the web console { #multi-architecture-uninstalling-using-web-console_multiarch-tuning-operator }
