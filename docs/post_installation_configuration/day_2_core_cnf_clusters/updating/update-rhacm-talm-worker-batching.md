---
title: Prepare worker node pools before a cluster update with TALM
---

# Prepare worker node pools before a cluster update with TALM { #core-cluster-upgrades-worker-batching }
