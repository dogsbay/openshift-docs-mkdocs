...
## Starting the cluster update { #update-starting-the-cluster-update_completing-the-z-stream-update }
...
## Updating the worker nodes { #update-updating-the-worker-nodes_completing-the-z-stream-update }
...
## Verifying the health of the newly updated cluster { #update-verifying-the-health-of-the-newly-updated-cluster_completing-the-z-stream-update }
