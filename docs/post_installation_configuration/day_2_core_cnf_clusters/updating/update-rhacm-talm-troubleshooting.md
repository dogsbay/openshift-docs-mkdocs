...
## Diagnosing a ClusterGroupUpgrade CR stuck in Preparing state { #core-cluster-upgrade-ts-cgu-preparing_core-cluster-upgrades-troubleshooting }
...
## Diagnosing a ClusterGroupUpgrade CR that failed on some clusters { #core-cluster-upgrade-ts-cgu-failed_core-cluster-upgrades-troubleshooting }
...
## Diagnosing degraded cluster Operators during an update { #core-cluster-upgrade-ts-operator-degraded_core-cluster-upgrades-troubleshooting }
...
## Diagnosing an update stuck in Working towards state { #core-cluster-upgrade-ts-update-stuck_core-cluster-upgrades-troubleshooting }
...
## Diagnosing worker nodes stuck in NotReady state { #core-cluster-upgrade-ts-nodes-notready_core-cluster-upgrades-troubleshooting }
...
## Diagnosing a stuck worker node update { #core-cluster-upgrade-ts-worker-update-stuck_core-cluster-upgrades-troubleshooting }
...
## Diagnosing etcd issues during control plane updates { #core-cluster-upgrade-ts-etcd_core-cluster-upgrades-troubleshooting }
...
## Diagnosing image pull failures during updates { #core-cluster-upgrade-ts-image-pull_core-cluster-upgrades-troubleshooting }
...
## Diagnosing update timeout exceeded { #core-cluster-upgrade-ts-timeout_core-cluster-upgrades-troubleshooting }
...
## Resolving a noncompliant policy hold during an update { #core-cluster-upgrade-ts-noncompliant-policy_core-cluster-upgrades-troubleshooting }
...
## Collecting diagnostic information for Red Hat support { #core-cluster-upgrade-ts-collect-diagnostics_core-cluster-upgrades-troubleshooting }
