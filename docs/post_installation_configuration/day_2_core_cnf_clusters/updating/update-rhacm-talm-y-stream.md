---
title: Complete a y-stream cluster update with TALM
---

# Complete a y-stream cluster update with TALM { #core-cluster-upgrades-y-stream }
...
## Updating clusters through y-stream releases { #core-cluster-upgrade-y-stream_core-cluster-upgrades-y-stream }
...
## Updating through sequential y-stream releases { #core-cluster-upgrade-y-stream-sequential_core-cluster-upgrades-y-stream }
