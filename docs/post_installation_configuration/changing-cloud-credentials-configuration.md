...
## Rotating cloud provider credentials { #post-install-rotate-cloud-creds_changing-cloud-credentials-configuration }
...
<tr>
  <td>RHOSP</td>
  <td><code>openstack-credentials</code></td>
</tr>
<tr>
  <td>VMware vSphere</td>
  <td><code>vsphere-creds</code></td>
</tr>
</tbody>
</table>
...
- [The Cloud Credential Operator in passthrough mode](../authentication/managing_cloud_provider_credentials/cco-mode-passthrough.md#cco-mode-passthrough)
...
## Removing cloud provider credentials { #post-install-remove-cloud-creds_changing-cloud-credentials-configuration }
...
### Removing cloud provider credentials { #manually-removing-cloud-creds_changing-cloud-credentials-configuration }
...
3. Click the Options menu ![](../images/kebab.png "Options menu") in the same row as the secret and select **Delete Secret**.
...
## Enabling token-based authentication { #post-install-enable-token-auth_changing-cloud-credentials-configuration }
...
### Enabling Microsoft Entra Workload ID on an existing cluster { #enabling-entra-workload-id-existing-cluster_changing-cloud-credentials-configuration }
...
### Enabling AWS Security Token Service (STS) on an existing cluster { #enabling-aws-sts-existing-cluster_changing-cloud-credentials-configuration }
...
### Verifying that a cluster uses short-term credentials { #cco-ccoctl-install-verifying_changing-cloud-credentials-configuration }
