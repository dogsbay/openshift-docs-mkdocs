...
## How an egress firewall works in a project { #nw-egress-firewall-about_configuring-egress-firewall-ovn }
...
### Limitations of an egress firewall { #limitations-of-an-egress-firewall-ovn-k_configuring-egress-firewall-ovn }
...
### Matching order for egress firewall policy rules { #policy-rule-order-ovn-k_configuring-egress-firewall-ovn }
...
### How Domain Name Server (DNS) resolution works { #domain-name-server-resolution-ovn-k_configuring-egress-firewall-ovn }
...
#### Improved DNS resolution and resolving wildcard domain names { #nw-coredns-egress-firewall_configuring-egress-firewall-ovn }
...
## EgressFirewall custom resource (CR) { #nw-egress-firewall-object_configuring-egress-firewall-ovn }
...
### EgressFirewall rules { #egress-firewall-rules_configuring-egress-firewall-ovn }
...
### Example EgressFirewall CR { #egress-firewall-example_configuring-egress-firewall-ovn }
...
### Example EgressFirewall CR using nodeSelector { #configuring-NodeSelector-egfw-example_configuring-egress-firewall-ovn }
