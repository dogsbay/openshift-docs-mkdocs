...
## Network policies and their scope { #nw-anp-np-scope }
...
## How network policy is evaluated and applied { #nw-anp-np-evaluation }
...
![OVN-Kubernetes Access Control List (ACL)](../../images/615_OpenShift_OVN-K_ACLs_0324.png)
