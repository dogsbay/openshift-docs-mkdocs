...
![A diagram showing multiple Ingress Controllers with different route selectors serving any route containing a label that matches a given route selector regardless of the namespace a route belongs to](../../../images/nw-sharding-route-labels.png)
...
- [Baseline Ingress Controller (router) performance](../../../scalability_and_performance/optimization/routing-optimization.md#baseline-router-performance_routing-optimization)
- [Configuring the Ingress Controller](../../networking_operators/ingress-operator.md#configuring-ingress-controller)
