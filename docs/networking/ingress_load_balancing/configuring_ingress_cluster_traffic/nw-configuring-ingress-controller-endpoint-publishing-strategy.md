...
![OpenShift Container Platform Ingress NodePort endpoint publishing strategy](../../../images/202_OpenShift_Ingress_0222_node_port.png)
...
- [Setting RHOSP Cloud Controller Manager options](../../../installing/installing_openstack/installing-openstack-installer-custom.md#installation-osp-setting-cloud-provider-options_installing-openstack-installer-custom)
- [User-provisioned DNS requirements](../../../installing/installing_platform_agnostic/installing-platform-agnostic.md#installation-dns-user-infra_installing-platform-agnostic)
