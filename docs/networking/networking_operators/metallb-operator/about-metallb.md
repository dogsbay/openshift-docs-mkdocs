...
- [Comparison: Fault tolerant access to external IP addresses](../../ingress_load_balancing/configuring_ingress_cluster_traffic/overview-traffic.md#overview-traffic-comparision_overview-traffic)
- [Removing IP failover](../../configuring_network_settings/configuring-ipfailover.md#nw-ipfailover-remove_configuring-ipfailover)
- [Deployment specifications for MetalLB](metallb-operator-install.md#nw-metallb-operator-deployment-specifications-for-metallb_metallb-operator-install)
