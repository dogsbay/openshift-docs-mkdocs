...
### Advantages of PTP over NTP { #ptp-advantages-over-ntp_about-ptp }
...
- [Disabling chrony time service](../../../machine_configuration/machine-configs-configure.md#cnf-disable-chronyd_machine-configs-configure)
...
### Handling leap second events in GNSS-synced PTP grandmaster clocks { #handling-leap-second-events-in-gnss_about-ptp }
...
### Hardware requirements { #hardware-requirements_about-ptp }
