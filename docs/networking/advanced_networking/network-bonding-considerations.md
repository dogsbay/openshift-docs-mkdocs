...
## Open vSwitch (OVS) bonding { #nw-ovs-bonding_network-bonding-considerations }
...
### Enable active-backup mode for your cluster { #enable-active-backup-mode_network-bonding-considerations }
...
### Enabling OVS balance-slb mode for your cluster { #enabling-OVS-balance-slb-mode_network-bonding-considerations }
...
## Kernel bonding { #nw-kernel-bonding_network-bonding-considerations }
