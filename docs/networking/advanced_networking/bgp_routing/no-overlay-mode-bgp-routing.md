...
## Understanding no-overlay mode for layer-3 networks using Border Gateway Protocol (BGP) { #nw-no-overlay-overview_no-overlay-mode-bgp-routing }
...
## Plan underlay routing and BGP for your cluster { #nw-no-overlay-planning_no-overlay-mode-bgp-routing }
...
## Enable underlay routing for the default cluster network { #nw-no-overlay-enable-default-network_no-overlay-mode-bgp-routing }
...
## Create a ClusterUserDefinedNetwork CR that uses underlay routing { #nw-no-overlay-enable-cudn_no-overlay-mode-bgp-routing }
...
## Reference for Cluster Network Operator (CNO) settings for default network underlay routing { #nw-no-overlay-default-network-config-ref_no-overlay-mode-bgp-routing }
...
```yaml title="Example CNO CR with BGP, no-overlay, and managed routing"
apiVersion: operator.openshift.io/v1
kind: Network
metadata:
  name: cluster
...
## Reference for underlay routing settings on a ClusterUserDefinedNetwork custom resource (CR) { #nw-no-overlay-cudn-config-ref_no-overlay-mode-bgp-routing }
...
## Troubleshoot connectivity for pods that use underlay routing { #nw-no-overlay-troubleshooting_no-overlay-mode-bgp-routing }
