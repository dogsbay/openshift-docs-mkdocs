...
## Differences between Istio and Red Hat OpenShift Service Mesh { #ossm-vs-istio_ossm-vs-istio }

The following features are different in Service Mesh and Istio.

### Command-line tool { #ossm-cli-tool_ossm-vs-istio }

The command-line tool for Red Hat OpenShift Service Mesh is `oc`.  Red Hat OpenShift Service Mesh does not support `istioctl`.

### Installation and upgrades { #ossm-installation-upgrade_ossm-vs-istio }
...
### Automatic injection { #ossm-automatic-injection_ossm-vs-istio }
...
### Istio Role Based Access Control features { #ossm-rbac_ossm-vs-istio }
...
### OpenSSL { #ossm-openssl_ossm-vs-istio }
...
### External workloads { #ossm-external-workloads_ossm-vs-istio }
...
### Virtual Machine Support { #ossm-virtual-machine-support_ossm-vs-istio }
...
### Component modifications { #ossm-component-modifications_ossm-vs-istio }
...
### Envoy filters { #ossm-envoy-filters_ossm-vs-istio }
...
### Envoy services { #ossm-envoy-services_ossm-vs-istio }

Red Hat OpenShift Service Mesh does not support QUIC-based services.

### Istio Container Network Interface (CNI) plugin { #ossm-cni_ossm-vs-istio }
...
### Global mTLS settings { #ossm-global-mtls_ossm-vs-istio }
...
### Gateways { #ossm-gateways_ossm-vs-istio }
...
### Multicluster configurations { #ossm-multicluster-configuration_ossm-vs-istio }
...
### Custom Certificate Signing Requests (CSR) { #ossm-certificate-signing-request_ossm-vs-istio }

You cannot configure Red Hat OpenShift Service Mesh to process CSRs through the Kubernetes certificate authority (CA).

### Routes for Istio Gateways { #ossm-routes-gateways_ossm-vs-istio }
...
#### Catch-all domains { #ossm-catch-all-domains_ossm-vs-istio }
...
#### Subdomains { #ossm-subdomains_ossm-vs-istio }
...
#### Transport layer security { #ossm-tls_ossm-vs-istio }
...
## Multitenant installations { #ossm-multitenant-install_ossm-vs-istio }
...
### Multitenancy versus cluster-wide installations { #ossm-mt-vs-clusterwide_ossm-vs-istio }
...
### Cluster scoped resources { #ossm-cluster-scoped-resources_ossm-vs-istio }
...
## Kiali and service mesh { #ossm-kiali-service-mesh_ossm-vs-istio }
...
## Distributed tracing and service mesh { #ossm-jaeger-service-mesh_ossm-vs-istio }
