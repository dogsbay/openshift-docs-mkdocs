...
## Discovering console addresses { #ossm-observability-addresses_observability }
...
## Viewing service mesh data in the Kiali console { #ossm-observability-visual_observability }
...
### Changing graph layouts in Kiali { #ossm-observability-topology_observability }
...
### Viewing logs in the Kiali console { #ossm-viewing-logs_observability }
...
### Viewing metrics in the Kiali console { #ossm-viewing-metrics_observability }
...
## Distributed tracing { #ossm-overview-distr-tracing_observability }
...
### Configuring the Red Hat OpenShift Distributed Tracing Platform and the Red Hat build of OpenTelemetry { #ossm-configuring-distr-tracing-tempo_observability }
...
#### Configuring the `OpenTelemetryCollector` in a mTLS encrypted Service Mesh member namespace { #configuring-otel-collector-mtls-encrypted-namespace_observability }
...
#### Configuring the Red Hat OpenShift Distributed Tracing Platform in a mTLS encrypted Service Mesh member namespace { #configuring-distr-tracing-tempo-mtls-encrypted-namespace_observability }
...
### Connecting an existing distributed tracing Jaeger instance { #ossm-config-external-jaeger_observability }
...
### Adjusting the sampling rate { #ossm-config-sampling_observability }
...
## Accessing the Jaeger console { #ossm-accessing-jaeger-console_observability }
...
## Accessing the Grafana console { #ossm-access-grafana_observability }
...
## Accessing the Prometheus console { #ossm-access-prometheus_observability }
...
## Integrating with user-workload monitoring { #ossm-integrating-with-user-workload-monitoring_observability }
