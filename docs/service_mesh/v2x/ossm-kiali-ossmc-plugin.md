...
## About the OpenShift Service Mesh Console plugin { #ossm-kiali-ossmc-plugin-user-guide_ossm-kiali-ossmc-plugin }
...
## Installing OpenShift Service Mesh Console plugin using the OpenShift Container Platform web console { #ossm-kiali-ossmc-plugin-install-web-console_ossm-kiali-ossmc-plugin }
...
## Installing OpenShift Service Mesh Console plugin using the CLI { #ossm-kiali-ossmc-plugin-install-cli_ossm-kiali-ossmc-plugin }
...
## Uninstalling OpenShift Service Mesh Console plugin using the OpenShift Container Platform web console { #ossm-kiali-ossmc-plugin-uninstall-web-console_ossm-kiali-ossmc-plugin }
...
## Uninstalling OpenShift Service Mesh Console plugin using the CLI { #ossm-kiali-ossmc-plugin-uninstall-cli_ossm-kiali-ossmc-plugin }
