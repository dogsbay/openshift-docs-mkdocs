...
## Understanding versioning { #ossm-versioning_ossm-upgrade }
...
### How versioning affects Service Mesh upgrades { #_how_versioning_affects_service_mesh_upgrades }
...
### Understanding Service Mesh versions { #ossm-versions_ossm-upgrade }
...
## Upgrade considerations { #ossm-upgrade-considerations_ossm-upgrade }
...
### Known issues that may affect upgrade { #ossm-upgrade-known-issues_ossm-upgrade }
...
## Upgrading the Operators { #ossm-upgrading-operator_ossm-upgrade }
...
### Upgrade changes from version 2.5 to version 2.6 { #ossm-upgrade-25-26-changes_ossm-upgrade }

#### Red Hat OpenShift Distributed Tracing Platform (Jaeger) default setting change { #_jaegername_default_setting_change }
...
#### Envoy sidecar container default setting change { #_envoy_sidecar_container_default_setting_change }
...
### Upgrade changes from version 2.4 to version 2.5 { #ossm-upgrade-24-25-changes_ossm-upgrade }
...
### Upgrade changes from version 2.3 to version 2.4 { #ossm-upgrade-23-24-changes_ossm-upgrade }
...
### Upgrade changes from version 2.2 to version 2.3 { #ossm-upgrade-22-23-changes_ossm-upgrade }
...
### Upgrade changes from version 2.1 to version 2.2 { #ossm-upgrade-21-22-changes_ossm-upgrade }
...
### Upgrade changes from version 2.0 to version 2.1 { #ossm-upgrade-20-21-changes_ossm-upgrade }
...
### Upgrading the Service Mesh control plane { #ossm-upgrading-smcp_ossm-upgrade }
...
### Migrating Red Hat OpenShift Service Mesh from version 1.1 to version 2.0 { #ossm-migrating-to-20_ossm-upgrade }
...
#### Upgrading Red Hat OpenShift Service Mesh { #ossm-migrating_ossm-upgrade }
...
#### Configuring the 2.0 ServiceMeshControlPlane { #ossm-migrating-smcp_ossm-upgrade }
...
##### Architecture changes { #ossm-migrating-differences-arch_ossm-upgrade }
...
##### Annotation changes { #ossm-migrating-differences-annotation_ossm-upgrade }
...
##### Behavioral changes { #ossm-migrating-differences-behavior_ossm-upgrade }
...
##### Migration details for unsupported resources { #ossm-migrating-unsupported-resources_ossm-upgrade }
...
##### Mixer plugins { #ossm-migrating-mixer_ossm-upgrade }
...
##### Mutual TLS changes { #ossm-migrating-mtls_ossm-upgrade }
...
###### Other mTLS Examples { #_other_mtls_examples }
...
```yaml title="Example Policy resource"
...
```yaml title="Example PeerAuthentication resource"
...
#### Configuration recipes { #ossm-migrating-config-recipes_ossm-upgrade }

You can configure the following items with these configuration recipes.

##### Mutual TLS in a data plane { #ossm-migrating-config-mtls_ossm-upgrade }
...
##### Custom signing key { #ossm-migrating-config-sign-key_ossm-upgrade }
...
##### Tracing { #ossm-migrating-config-tracing_ossm-upgrade }
...
##### Visualization { #ossm-migrating-config-vis_ossm-upgrade }
...
##### Resource utilization and scheduling { #_resource_utilization_and_scheduling }
...
#### Next steps for migrating your applications and workloads { #ossm-migrrating-apps_ossm-upgrade }
...
### Updating your applications and workloads { #ossm-upgrading-apps-workloads_ossm-upgrade }
