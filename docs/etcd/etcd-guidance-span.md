...
## Deployment caveats for spanned clusters { #deployment-caveats-span_etcd-guidance-span }
...
## Infrastructure as a Service (IaaS) and cloud provider considerations { #iaas-cloud-provider-considerations-span_etcd-guidance-span }
...
## Site recommendations for multisite clusters { #site-recommendations-span_etcd-guidance-span }
...
## Requirements for etcd, networking, and storage { #requirements-etcd-hardware-span_etcd-guidance-span }
...
### etcd requirements { #etcd-reqs-span_etcd-guidance-span }
...
### Network requirements { #etcd-network-reqs-span_etcd-guidance-span }
...
### Storage requirements { #etcd-storage-reqs-span_etcd-guidance-span }
...
## Workload placement considerations { #workload-placement-considerations-span_etcd-guidance-span }
