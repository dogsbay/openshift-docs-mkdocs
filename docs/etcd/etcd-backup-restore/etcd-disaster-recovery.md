...
# Disaster recovery { #etcd-disaster-recovery }
...
## Restoring etcd quorum for high availability clusters { #dr-restoring-etcd-quorum-ha_etcd-disaster-recovery }
...
## About restoring to an earlier cluster state { #dr-scenario-2-restoring-cluster-state-about_etcd-disaster-recovery }
...
## Restoring to an earlier cluster state for a single node { #dr-restoring-cluster-state-sno_etcd-disaster-recovery }
...
## Restoring to an earlier cluster state for more than one node { #dr-scenario-2-restoring-cluster-state_etcd-disaster-recovery }
...
## Issues and workarounds for restoring a persistent storage state { #dr-scenario-cluster-state-issues_etcd-disaster-recovery }
...
## Recovering from expired control plane certificates { #dr-scenario-3-recovering-expired-certs_etcd-disaster-recovery }
...
## Testing restore procedures { #dr-testing-restore-procedures_etcd-disaster-recovery }
