...
## Creating OADP resources for the image-based upgrade with GitOps ZTP { #ztp-image-based-upgrade-prep-oadp_ztp-gitops }
...
## Labeling extra manifests for the image-based upgrade with GitOps ZTP { #ztp-image-based-upgrade-prep-label-extramanifests_ztp-gitops }
