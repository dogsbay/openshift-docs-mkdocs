...
## Setting up the disconnected environment { #talo-platform-prepare-for-update-env-setup_ztp-talm-pg }
...
## Performing a platform update with PolicyGenerator CRs { #talo-platform-update-PolicyGenerator_ztp-talm-pg }
...
## Performing an Operator update with PolicyGenerator CRs { #talo-operator-update-PolicyGenerator_ztp-talm-pg }
...
## Troubleshooting missed Operator updates with PolicyGenerator CRs { #cnf-topology-aware-lifecycle-manager-operator-troubleshooting-PolicyGenerator_ztp-talm-pg }
...
## Removing Performance Addon Operator subscriptions from deployed clusters with PolicyGenerator CRs { #talm-pao-update-PolicyGenerator_ztp-talm-pg }
...
### Creating the custom resources for precaching { #talm-prechache-user-specified-images-preparing-crs_ztp-talm-pg }
...
## About the auto-created ClusterGroupUpgrade CR for GitOps ZTP { #talo-precache-autocreated-cgu-for-ztp_ztp-talm-pg }
