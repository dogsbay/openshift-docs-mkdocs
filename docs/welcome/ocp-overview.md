...
# Introduction to OpenShift Container Platform { #ocp-overview }
...
- [Preparing to install on a single node](../installing/installing_sno/install-sno-preparing-to-install-sno.md#preparing-to-install-sno)
