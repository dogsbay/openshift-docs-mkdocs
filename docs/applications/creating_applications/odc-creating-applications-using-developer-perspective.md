...
- **Getting started resources**: Use these resources to help you get started with Developer Console. You can choose to hide the header using the Options menu ![](../../images/kebab.png "Options menu").
...
- You have created a project or have access to a project with the appropriate [roles and permissions](../../authentication/using-rbac.md#default-roles_using-rbac) to create applications and other workloads in OpenShift Container Platform.
...
## Creating applications by using Quick Starts { #odc-using-quickstarts_odc-creating-applications-using-developer-perspective }
...
## Deploying a Java application by uploading a JAR file { #odc-deploying-java-applications_odc-creating-applications-using-developer-perspective }
...
## Using the Devfile registry to access devfiles { #odc-using-the-devfile-registry_odc-creating-applications-using-developer-perspective }
...
- For more information about adding a new user to a project, see [Working with projects](../projects/working-with-projects.md#odc-providing-project-permissions-using-developer-perspective_projects).
- For more information about creating a Helm Chart repository, see [Creating Helm Chart repositories](../working_with_helm_charts/configuring-custom-helm-chart-repositories.md#odc-creating-helm-releases-using-developer-perspective_configuring-custom-helm-chart-repositories).
