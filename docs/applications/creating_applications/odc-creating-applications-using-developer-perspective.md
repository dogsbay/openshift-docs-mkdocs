...
- [Enabling the Developer perspective in the web console](../../web_console/web-console-overview.md#enabling-developer-perspective_web-console)
- [Accessing the web console](../../web_console/web-console.md#web-console)
- [Default cluster roles](../../authentication/using-rbac.md#default-roles_using-rbac)
...
- [Installing the OpenShift Virtualization Operator](../../virt/install/installing-virt.md#virt-subscribing-cli_installing-virt)
...
- [Working with projects](../projects/working-with-projects.md#odc-providing-project-permissions-using-developer-perspective_projects)
- [Creating Helm Chart repositories](../working_with_helm_charts/configuring-custom-helm-chart-repositories.md#odc-creating-helm-releases-using-developer-perspective_configuring-custom-helm-chart-repositories)
