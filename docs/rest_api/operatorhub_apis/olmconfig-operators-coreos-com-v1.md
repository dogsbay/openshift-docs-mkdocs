...
### /apis/operators.coreos.com/v1/olmconfigs { #_apisoperatorscoreoscomv1olmconfigs }
...
| HTTP code          | Reponse body                                                                  |
| ------------------ | ----------------------------------------------------------------------------- |
| 200 - OK           | [`OLMConfigList`](../objects.md#com-coreos-operators-v1-OLMConfigList) schema |
| 401 - Unauthorized | Empty                                                                         |
