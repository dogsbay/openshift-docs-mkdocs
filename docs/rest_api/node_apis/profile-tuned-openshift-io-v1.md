...
### .spec.config.tunedConfig { #_specconfigtunedconfig }
...
### /apis/tuned.openshift.io/v1/profiles { #_apistunedopenshiftiov1profiles }
...
| ------------------ | ----------------------------------------------------------------------- |
| 200 - OK           | [`ProfileList`](../objects.md#io-openshift-tuned-v1-ProfileList) schema |
