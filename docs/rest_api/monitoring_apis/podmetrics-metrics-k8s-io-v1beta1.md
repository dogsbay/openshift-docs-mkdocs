...
### /apis/metrics.k8s.io/v1beta1/pods { #_apismetricsk8siov1beta1pods }
...
| --------- | ----------------------------------------------------------------------------------------------- |
| 200 - OK  | [`PodMetricsList`](../objects.md#io-k8s-metrics-pkg-apis-metrics-v1beta1-PodMetricsList) schema |
