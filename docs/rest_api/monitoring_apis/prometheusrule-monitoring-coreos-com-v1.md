...
### /apis/monitoring.coreos.com/v1/prometheusrules { #_apismonitoringcoreoscomv1prometheusrules }
...
| ------------------ | ---------------------------------------------------------------------------------------- |
| 200 - OK           | [`PrometheusRuleList`](../objects.md#com-coreos-monitoring-v1-PrometheusRuleList) schema |
