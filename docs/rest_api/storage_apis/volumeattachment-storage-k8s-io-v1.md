...
### .status.attachError { #_statusattacherror }
...
| `time`      | [`Time`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | time represents the time the error was encountered.                                                                                                                                                                               |
...
### /apis/storage.k8s.io/v1/volumeattachments { #_apisstoragek8siov1volumeattachments }
...
| HTTP code          | Reponse body                                                                              |
| ------------------ | ----------------------------------------------------------------------------------------- |
| 200 - OK           | [`VolumeAttachmentList`](../objects.md#io-k8s-api-storage-v1-VolumeAttachmentList) schema |
| 401 - Unauthorized | Empty                                                                                     |
