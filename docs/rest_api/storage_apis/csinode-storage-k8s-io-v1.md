...
| `metadata`   | [`ObjectMeta`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-ObjectMeta) | Standard object’s metadata. metadata.name must be the Kubernetes node name.                                                                                                                                                                                                                        |
...
### .spec.drivers\[\].allocatable { #_specdriversallocatable }
...
### /apis/storage.k8s.io/v1/csinodes { #_apisstoragek8siov1csinodes }
...
| HTTP code          | Reponse body                                                            |
| ------------------ | ----------------------------------------------------------------------- |
| 200 - OK           | [`CSINodeList`](../objects.md#io-k8s-api-storage-v1-CSINodeList) schema |
| 401 - Unauthorized | Empty                                                                   |
