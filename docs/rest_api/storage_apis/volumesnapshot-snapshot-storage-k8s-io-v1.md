...
### /apis/snapshot.storage.k8s.io/v1/volumesnapshots { #_apissnapshotstoragek8siov1volumesnapshots }
...
| ------------------ | ------------------------------------------------------------------------------------------ |
| 200 - OK           | [`VolumeSnapshotList`](../objects.md#io-k8s-storage-snapshot-v1-VolumeSnapshotList) schema |
