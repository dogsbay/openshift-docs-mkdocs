...
### /apis/template.openshift.io/v1/templates { #_apistemplateopenshiftiov1templates }
...
| ------------------ | ---------------------------------------------------------------------------------------- |
| 200 - OK           | [`TemplateList`](../objects.md#com-github-openshift-api-template-v1-TemplateList) schema |
