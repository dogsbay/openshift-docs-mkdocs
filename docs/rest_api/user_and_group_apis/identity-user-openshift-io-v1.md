...
| `user`             | [`ObjectReference`](../objects.md#io-k8s-api-core-v1-ObjectReference)         | user is a reference to the user this identity is associated with Both Name and UID must be set                                                                                                                                                                                                     |
...
| HTTP code          | Reponse body                                                                         |
| ------------------ | ------------------------------------------------------------------------------------ |
| 200 - OK           | [`IdentityList`](../objects.md#com-github-openshift-api-user-v1-IdentityList) schema |
| 401 - Unauthorized | Empty                                                                                |
