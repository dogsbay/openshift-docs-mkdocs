...
| `identity`   | [`ObjectReference`](../objects.md#io-k8s-api-core-v1-ObjectReference)         | identity is a reference to an identity                                                                                                                                                                                                                                                             |
...
| `user`       | [`ObjectReference`](../objects.md#io-k8s-api-core-v1-ObjectReference)         | user is a reference to a user                                                                                                                                                                                                                                                                      |
...
### /apis/user.openshift.io/v1/useridentitymappings { #_apisuseropenshiftiov1useridentitymappings }
