...
### .spec.boundObjectRef { #_specboundobjectref }
...
| Property              | Type                                                              | Description                                                          |
| --------------------- | ----------------------------------------------------------------- | -------------------------------------------------------------------- |
| `expirationTimestamp` | [`Time`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | ExpirationTimestamp is the time of expiration of the returned token. |
