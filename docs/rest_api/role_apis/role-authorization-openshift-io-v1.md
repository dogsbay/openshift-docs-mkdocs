...
### /apis/authorization.openshift.io/v1/roles { #_apisauthorizationopenshiftiov1roles }
...
| ------------------ | ------------------------------------------------------------------------------------- |
| 200 - OK           | [`RoleList`](../objects.md#com-github-openshift-api-authorization-v1-RoleList) schema |
