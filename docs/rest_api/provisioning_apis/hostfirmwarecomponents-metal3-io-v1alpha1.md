...
### /apis/metal3.io/v1alpha1/hostfirmwarecomponents { #_apismetal3iov1alpha1hostfirmwarecomponents }
...
| ------------------ | -------------------------------------------------------------------------------------------------- |
| 200 - OK           | [`HostFirmwareComponentsList`](../objects.md#io-metal3-v1alpha1-HostFirmwareComponentsList) schema |
