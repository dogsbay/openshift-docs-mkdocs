...
| Property                     | Type      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ---------------------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `concurrencyPolicy`          | `string`  | Specifies how to treat concurrent executions of a Job. Valid values are:<br>- "Allow" (default): allows CronJobs to run concurrently; - "Forbid": forbids concurrent runs, skipping next run if previous run hasn’t finished yet; - "Replace": cancels currently running job and replaces it with a new one<br>Possible enum values:  - `"Allow"` allows CronJobs to run concurrently.  - `"Forbid"` forbids concurrent runs, skipping next run if previous hasn’t finished yet.  - `"Replace"` cancels currently running job and replaces it with a new one.                                                                                                                                                                                                                                                                                                        |
...
| `jobTemplate`                | `object`  | JobTemplateSpec describes the data a Job should have when created from a template                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
### .spec.jobTemplate { #_specjobtemplate }
...
| Property   | Type                                                                          | Description                                                                                                                                                                |
| ---------- | ----------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `metadata` | [`ObjectMeta`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-ObjectMeta) | Standard object’s metadata of the jobs created from this template. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata |
...
### .spec.jobTemplate.spec.podFailurePolicy.rules { #_specjobtemplatespecpodfailurepolicyrules }
...
### .spec.jobTemplate.spec.podFailurePolicy.rules\[\].onExitCodes { #_specjobtemplatespecpodfailurepolicyrulesonexitcodes }
...
### .spec.jobTemplate.spec.podFailurePolicy.rules\[\].onPodConditions { #_specjobtemplatespecpodfailurepolicyrulesonpodconditions }
...
### .spec.jobTemplate.spec.successPolicy { #_specjobtemplatespecsuccesspolicy }
...
### .spec.jobTemplate.spec.successPolicy.rules { #_specjobtemplatespecsuccesspolicyrules }
...
| Property             | Type                                                                          | Description                                                            |
| -------------------- | ----------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `active`             | [`array (ObjectReference)`](../objects.md#io-k8s-api-core-v1-ObjectReference) | A list of pointers to currently running jobs.                          |
| `lastScheduleTime`   | [`Time`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time)             | Information when was the last time the job was successfully scheduled. |
| `lastSuccessfulTime` | [`Time`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time)             | Information when was the last time the job successfully completed.     |
...
### /apis/batch/v1/cronjobs { #_apisbatchv1cronjobs }
...
| ------------------ | --------------------------------------------------------------------- |
| 200 - OK           | [`CronJobList`](../objects.md#io-k8s-api-batch-v1-CronJobList) schema |
