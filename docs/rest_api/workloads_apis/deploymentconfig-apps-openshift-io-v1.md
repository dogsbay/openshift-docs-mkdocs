...
| `template`             | [`PodTemplateSpec`](../objects.md#io-k8s-api-core-v1-PodTemplateSpec) | template is the object that describes the pod that will be created if insufficient replicas are detected.                                                                                                                                                                                                                                                                |
...
| `resources`             | [`ResourceRequirements`](../objects.md#io-k8s-api-core-v1-ResourceRequirements) | resources contains resource requirements to execute the deployment and any hooks.                                                                                              |
...
### .spec.strategy.customParams { #_specstrategycustomparams }
...
| `environment` | [`array (EnvVar)`](../objects.md#io-k8s-api-core-v1-EnvVar) | environment holds the environment which will be given to the container for Image. |
...
### .spec.strategy.recreateParams.mid { #_specstrategyrecreateparamsmid }
...
### .spec.strategy.recreateParams.mid.execNewPod { #_specstrategyrecreateparamsmidexecnewpod }
...
| `env`           | [`array (EnvVar)`](../objects.md#io-k8s-api-core-v1-EnvVar) | env is a set of environment variables to supply to the hook pod’s container.                                                                                                                     |
...
| `to`            | [`ObjectReference`](../objects.md#io-k8s-api-core-v1-ObjectReference) | to is the target ImageStreamTag to set the container’s image onto.                                                                                                                                                         |
...
### .spec.strategy.recreateParams.post.execNewPod { #_specstrategyrecreateparamspostexecnewpod }
...
### .spec.strategy.recreateParams.pre.execNewPod { #_specstrategyrecreateparamspreexecnewpod }
...
### .spec.strategy.rollingParams.post { #_specstrategyrollingparamspost }
...
### .spec.strategy.rollingParams.post.execNewPod { #_specstrategyrollingparamspostexecnewpod }
...
### .spec.strategy.rollingParams.pre.execNewPod { #_specstrategyrollingparamspreexecnewpod }
...
### .spec.triggers\[\].imageChangeParams { #_spectriggersimagechangeparams }
...
| `from`               | [`ObjectReference`](../objects.md#io-k8s-api-core-v1-ObjectReference) | from is a reference to an image stream tag to watch for changes. From.Name is the only required subfield - if From.Namespace is blank, the namespace of the current deployment trigger will be used.                                                                                                                                                                                       |
...
### .status.details.causes { #_statusdetailscauses }
...
### .status.details.causes\[\].imageTrigger { #_statusdetailscausesimagetrigger }
...
| Property | Type                                                                  | Description                                                                                                                                            |
| -------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `from`   | [`ObjectReference`](../objects.md#io-k8s-api-core-v1-ObjectReference) | from is a reference to the changed object which triggered a deployment. The field may have the kinds DockerImage, ImageStreamTag, or ImageStreamImage. |
...
### /apis/apps.openshift.io/v1/deploymentconfigs { #_apisappsopenshiftiov1deploymentconfigs }
...
| ------------------ | ---------------------------------------------------------------------------------------------------- |
| 200 - OK           | [`DeploymentConfigList`](../objects.md#com-github-openshift-api-apps-v1-DeploymentConfigList) schema |
