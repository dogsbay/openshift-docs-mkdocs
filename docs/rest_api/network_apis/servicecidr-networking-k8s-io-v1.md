...
| Property     | Type                                                                                | Description                                                                                                     |
| ------------ | ----------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| `conditions` | [`array (Condition)`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-Condition) | conditions holds an array of metav1.Condition that describe the state of the ServiceCIDR. Current service state |
...
### /apis/networking.k8s.io/v1/servicecidrs { #_apisnetworkingk8siov1servicecidrs }
...
| HTTP code          | Reponse body                                                                       |
| ------------------ | ---------------------------------------------------------------------------------- |
| 200 - OK           | [`ServiceCIDRList`](../objects.md#io-k8s-api-networking-v1-ServiceCIDRList) schema |
| 401 - Unauthorized | Empty                                                                              |
