...
### /apis/networking.k8s.io/v1/ipaddresses { #_apisnetworkingk8siov1ipaddresses }
...
| HTTP code          | Reponse body                                                                   |
| ------------------ | ------------------------------------------------------------------------------ |
| 200 - OK           | [`IPAddressList`](../objects.md#io-k8s-api-networking-v1-IPAddressList) schema |
| 401 - Unauthorized | Empty                                                                          |
