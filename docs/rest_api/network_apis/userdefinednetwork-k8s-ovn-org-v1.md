...
### /apis/k8s.ovn.org/v1/userdefinednetworks { #_apisk8sovnorgv1userdefinednetworks }
...
| ------------------ | -------------------------------------------------------------------------------------- |
| 200 - OK           | [`UserDefinedNetworkList`](../objects.md#org-ovn-k8s-v1-UserDefinedNetworkList) schema |
