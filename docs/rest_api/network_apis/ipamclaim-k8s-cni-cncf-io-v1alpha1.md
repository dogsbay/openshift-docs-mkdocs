...
### .status.ownerPod { #_statusownerpod }
...
### /apis/k8s.cni.cncf.io/v1alpha1/ipamclaims { #_apisk8scnicncfiov1alpha1ipamclaims }
...
| ------------------ | ------------------------------------------------------------------------------ |
| 200 - OK           | [`IPAMClaimList`](../objects.md#io-cncf-cni-k8s-v1alpha1-IPAMClaimList) schema |
