...
### /apis/k8s.cni.cncf.io/v1/network-attachment-definitions { #_apisk8scnicncfiov1network-attachment-definitions }
...
| ------------------ | ------------------------------------------------------------------------------------------------------------ |
| 200 - OK           | [`NetworkAttachmentDefinitionList`](../objects.md#io-cncf-cni-k8s-v1-NetworkAttachmentDefinitionList) schema |
