...
# ControllerRevision \[apps/v1\] { #controllerrevision-apps-v1 }
...
| `data`       | [`RawExtension`](../objects.md#io-k8s-apimachinery-pkg-runtime-RawExtension)  | Data is the serialized representation of the state.                                                                                                                                                                                                                                                |
...
### /apis/apps/v1/controllerrevisions { #_apisappsv1controllerrevisions }
...
| ------------------ | ------------------------------------------------------------------------------------------ |
| 200 - OK           | [`ControllerRevisionList`](../objects.md#io-k8s-api-apps-v1-ControllerRevisionList) schema |
