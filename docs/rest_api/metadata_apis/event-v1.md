...
| `eventTime`          | [`MicroTime`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-MicroTime)   | Time when this Event was first observed.                                                                                                                                                                                                                                                           |
| `firstTimestamp`     | [`Time`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time)             | The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)                                                                                                                                                                                                           |
...
| `lastTimestamp`      | [`Time`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-Time)             | The time at which the most recent occurrence of this event was recorded.                                                                                                                                                                                                                           |
...
| `lastObservedTime` | [`MicroTime`](../objects.md#io-k8s-apimachinery-pkg-apis-meta-v1-MicroTime) | Time of the last occurrence observed                               |
...
| ------------------ | ---------------------------------------------------------------- |
| 200 - OK           | [`EventList`](../objects.md#io-k8s-api-core-v1-EventList) schema |
