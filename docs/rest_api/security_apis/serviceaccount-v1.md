...
# ServiceAccount \[v1\] { #serviceaccount-v1 }
...
### /api/v1/serviceaccounts { #_apiv1serviceaccounts }
...
| ------------------ | ---------------------------------------------------------------------------------- |
| 200 - OK           | [`ServiceAccountList`](../objects.md#io-k8s-api-core-v1-ServiceAccountList) schema |
