...
### /apis/security.openshift.io/v1/securitycontextconstraints { #_apissecurityopenshiftiov1securitycontextconstraints }
...
| HTTP code          | Reponse body                                                                                                     |
| ------------------ | ---------------------------------------------------------------------------------------------------------------- |
| 200 - OK           | [`SecurityContextConstraintsList`](../objects.md#io-openshift-security-v1-SecurityContextConstraintsList) schema |
| 401 - Unauthorized | Empty                                                                                                            |
