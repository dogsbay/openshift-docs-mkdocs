...
| Property     | Type                                                                                | Description                                                                                                                                                                                                                 |
| ------------ | ----------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `conditions` | [`array (NamespaceCondition)`](../objects.md#io-k8s-api-core-v1-NamespaceCondition) | Represents the latest available observations of the project current state.                                                                                                                                                  |
...
### /apis/project.openshift.io/v1/projects { #_apisprojectopenshiftiov1projects }
...
| ------------------ | ------------------------------------------------------------------------------------- |
| 200 - OK           | [`ProjectList`](../objects.md#com-github-openshift-api-project-v1-ProjectList) schema |
