...
- [OpenShift Container Platform CLI (`oc`)](cli_reference/openshift_cli/getting-started-cli.md#cli-getting-started)
- [Helm CLI (`helm`)](applications/working_with_helm_charts/installing-helm.md#installing-helm)
- [`opm` CLI](cli_reference/opm/cli-opm-install.md#cli-opm-install)
- [Knative CLI (`kn`)](cli_reference/kn-cli-tools.md#kn-cli-tools)
- [OpenShift Pipelines CLI (`tkn`)](cli_reference/tkn_cli/installing-tkn.md#installing-tkn)
