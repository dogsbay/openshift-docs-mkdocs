...
1. [Create a project for the application](dev-app-web-console.md#getting-started-web-console-creating-new-project_dev-app-web-console).

    This step allows your application to be isolated from other cluster user’s workloads.

2. [Grant view permissions](dev-app-web-console.md#getting-started-web-console-granting-permissions_dev-app-web-console).
...
3. [Deploy the front-end application](dev-app-web-console.md#getting-started-web-console-deploying-first-image_dev-app-web-console).

    This step deploys the `parksmap` front-end application, exposes it externally, and scales it up to two instances.

4. [Deploy the back-end application](dev-app-web-console.md#getting-started-web-console-deploying-python-app_dev-app-web-console).

    This step deploys the `nationalparks` back-end application and exposes it externally.

5. [Deploy the database application](dev-app-web-console.md#getting-started-web-console-connecting-database_dev-app-web-console).
...
After you complete these steps, you can [view the national parks application in a web browser](dev-app-web-console.md#getting-started-web-console-view_dev-app-web-console).
...
- You have [logged in to the OpenShift Container Platform web console](../web_console/web-console.md#web-console-overview).

## Creating a project { #getting-started-web-console-creating-new-project_dev-app-web-console }
...
- [Viewing a project by using the web console](../applications/projects/working-with-projects.md#viewing-a-project-using-the-web-console_projects)

## Granting view permissions { #getting-started-web-console-granting-permissions_dev-app-web-console }
...
## Deploying the front-end application { #getting-started-web-console-deploying-first-image_dev-app-web-console }
...
- [Viewing the topology of your application](../applications/odc-viewing-application-composition-using-topology-view.md#odc-viewing-application-topology_viewing-application-composition-using-topology-view)

### Viewing pod details { #getting-started-web-console-examining-pod_dev-app-web-console }
...
- [Interacting with applications and components](../applications/odc-viewing-application-composition-using-topology-view.md#odc-interacting-with-applications-and-components_viewing-application-composition-using-topology-view)
- [Scaling application pods and checking builds and routes](../applications/odc-viewing-application-composition-using-topology-view.md#odc-scaling-application-pods-and-checking-builds-and-routes_viewing-application-composition-using-topology-view)
- [Labels and annotations used for the Topology view](../applications/odc-viewing-application-composition-using-topology-view.md#odc-labels-and-annotations-used-for-topology-view_viewing-application-composition-using-topology-view)

### Scaling up the application { #getting-started-web-console-scaling-app_dev-app-web-console }
...
- [Recommended practices for scaling the cluster](../scalability_and_performance/recommended-performance-scale-practices/recommended-control-plane-practices.md#recommended-scale-practices_recommended-control-plane-practices)

## Deploying the back-end application { #getting-started-web-console-deploying-python-app_dev-app-web-console }
...
- [Adding services to your application](../applications/odc-viewing-application-composition-using-topology-view.md#odc-adding-services-to-your-application_viewing-application-composition-using-topology-view)
- [Importing a codebase from Git to create an application](../applications/creating_applications/odc-creating-applications-using-developer-perspective.md#odc-importing-codebase-from-git-to-create-application_odc-creating-applications-using-developer-perspective)

## Deploying the database application { #getting-started-web-console-connecting-database_dev-app-web-console }
...
### Providing access to the database by creating a secret { #getting-started-web-console-creating-secret_dev-app-web-console }
...
### Loading data into the database { #getting-started-web-console-load-data-output_dev-app-web-console }
...
## Viewing the application in a web browser { #getting-started-web-console-view_dev-app-web-console }
