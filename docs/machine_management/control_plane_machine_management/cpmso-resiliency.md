...
### Failure domain platform support and configuration { #cpmso-failure-domains-provider_cpmso-resiliency }
...
### Balancing control plane machines { #cpmso-failure-domains-balancing_cpmso-resiliency }
...
## Recovery of failed control plane machines { #cpmso-control-plane-recovery_cpmso-resiliency }
...
## Quorum protection with machine lifecycle hooks { #machine-lifecycle-hook-deletion-etcd_cpmso-resiliency }
...
### Control plane deletion with quorum protection processing order { #machine-lifecycle-hook-deletion-etcd-order_cpmso-resiliency }
