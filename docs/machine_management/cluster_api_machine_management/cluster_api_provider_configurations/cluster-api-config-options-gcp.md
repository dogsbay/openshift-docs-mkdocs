...
## Sample YAML for configuring Google Cloud clusters { #cluster-api-sample-yaml-gcp_cluster-api-config-options-gcp }

The following example YAML files show configurations for a Google Cloud cluster.

### Sample YAML for a Cluster API machine template resource on Google Cloud { #capi-yaml-machine-template-gcp_cluster-api-config-options-gcp }
...
### Sample YAML for a Cluster API compute machine set resource on Google Cloud { #capi-yaml-machine-set-gcp_cluster-api-config-options-gcp }
