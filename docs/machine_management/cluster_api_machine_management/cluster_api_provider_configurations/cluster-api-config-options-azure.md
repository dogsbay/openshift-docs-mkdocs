...
## Sample YAML for a Cluster API machine template resource on Microsoft Azure { #capi-yaml-machine-template-azure_cluster-api-config-options-azure }
...
## Sample YAML for a Cluster API compute machine set resource on Microsoft Azure { #capi-yaml-machine-set-azure_cluster-api-config-options-azure }
