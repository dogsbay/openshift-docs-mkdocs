...
## Sample YAML for configuring VMware vSphere clusters { #cluster-api-sample-yaml-vsphere_cluster-api-config-options-vsphere }

The following example YAML files show configurations for a VMware vSphere cluster.

### Sample YAML for a Cluster API machine template resource on VMware vSphere { #capi-yaml-machine-template-vsphere_cluster-api-config-options-vsphere }
...
### Sample YAML for a Cluster API compute machine set resource on VMware vSphere { #capi-yaml-machine-set-vsphere_cluster-api-config-options-vsphere }
