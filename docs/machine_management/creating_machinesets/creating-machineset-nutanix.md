...
## Sample YAML for a compute machine set custom resource on Nutanix { #machineset-yaml-nutanix_creating-machineset-nutanix }
...
## Creating a compute machine set { #machineset-creating_creating-machineset-nutanix }
...
## Failure domains for Nutanix clusters { #mapi-failure-domain-nutanix_creating-machineset-nutanix }
...
## Improving reliability for multiple subnet configurations on Nutanix { #cpmso-ts-nutanix-multiple-subnet_creating-machineset-nutanix }
