...
## Compliance profiles { #compliance-supported-profiles_compliance-operator-supported-profiles }
...
### CIS compliance profiles { #cis-profiles_compliance-operator-supported-profiles }
...
### BSI Profile Support { #bsi-profiles_compliance-operator-supported-profiles }
...
### Essential Eight compliance profiles { #e8-profiles_compliance-operator-supported-profiles }
...
### FedRAMP High compliance profiles { #fedramp-high-profiles_compliance-operator-supported-profiles }
...
### FedRAMP Moderate compliance profiles { #fedramp-moderate-profiles_compliance-operator-supported-profiles }
...
### NERC-CIP compliance profiles { #nerc-cip-profiles_compliance-operator-supported-profiles }
...
### PCI-DSS compliance profiles { #pci-dss-profiles_compliance-operator-supported-profiles }
...
### STIG compliance profiles { #stig-profiles_compliance-operator-supported-profiles }
...
### About extended compliance profiles { #compliance-extended-profiles_compliance-operator-supported-profiles }
...
### Compliance Operator profile types { #compliance_profile_types_compliance-operator-supported-profiles }
