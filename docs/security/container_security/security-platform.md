...
## Isolating containers with multitenancy { #security-platform-multi-tenancy_security-platform }
...
## Protecting control plane with admission plugins { #security-platform-admission_security-platform }
...
### Security context constraints (SCCs) { #security-deployment-sccs_security-platform }
...
### Granting roles to service accounts { #security-service-account_security-platform }
...
## Authentication and authorization { #security-platform-authentication_security-platform }

### Controlling access using OAuth { #security-platform-auth-controlling-access_security-platform }
...
### API access control and management { #security-platform-api-access-control_security-platform }
...
### Red Hat Single Sign-On { #security-platform-red-hat-sso_security-platform }
...
### Secure self-service web console { #security-platform-auth-secure-self-service-web-console_security-platform }
...
## Managing certificates for the platform { #security-platform-certificates_security-platform }
...
### Configuring custom certificates { #security-platform-config-custom-certs_security-platform }
