...
## About the Entra ID OpenID Connect { #zero-trust-manager-entraid-oidc-about_zero-trust-manager-oidc-federation }
...
## About Vault OpenID Connect { #zero-trust-manager-vault-oidc-about_zero-trust-manager-oidc-federation }
