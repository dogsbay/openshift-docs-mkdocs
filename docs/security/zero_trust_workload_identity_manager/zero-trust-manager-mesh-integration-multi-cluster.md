...
## Multi-cluster SPIFFE Runtime Environment integration with Red Hat OpenShift Service Mesh { #zero-trust-manager-multi-cluster-spire-mesh-about_zero-trust-manager-mesh-integration-multi-cluster }
...
### What gets federated { #what-gets-federated_zero-trust-manager-mesh-integration-multi-cluster }
...
## Preparing the environment for multi-cluster SPIFFE Runtime Environment federation { #zero-trust-manager-prepare-spire-multi-cluster_zero-trust-manager-mesh-integration-multi-cluster }
...
## Deploying SPIFFE Runtime Environment with federation on both clusters { #zero-trust-manager-deploy-spire-federation-multi-cluster_zero-trust-manager-mesh-integration-multi-cluster }
...
## Configuring Red Hat OpenShift Service Mesh for multi-cluster SPIFFE Runtime Environment integration { #zero-trust-manager-configure-spire-mesh-multi-cluster_zero-trust-manager-mesh-integration-multi-cluster }
...
## Deploying the Red Hat OpenShift Service Mesh CNI on both clusters { #zero-trust-manager-deploy-istiocni_zero-trust-manager-mesh-integration-multi-cluster }
...
## Deploying the Istio custom resource with the federation configuration { #zero-trust-manager-deploy-istio-cr_zero-trust-manager-mesh-integration-multi-cluster }
...
## Verifying SPIRE integration with Istio on each cluster { #zero-trust-manager-verify-spire-istio-multi-cluster_zero-trust-manager-mesh-integration-multi-cluster }
...
## Verifying workload mTLS with SPIRE-issued identities on each cluster { #zero-trust-manager-mutual-tls-verification_zero-trust-manager-mesh-integration-multi-cluster }
...
## Deploying east-west gateways { #zero-trust-manager-deploy-east-west_zero-trust-manager-mesh-integration-multi-cluster }
...
## Exchanging remote secrets { #zero-trust-manager-exchange-remote-secrets_zero-trust-manager-mesh-integration-multi-cluster }
...
## Verifying cross-cluster service communication { #zero-trust-manager-multi-mesh-verification_zero-trust-manager-mesh-integration-multi-cluster }
