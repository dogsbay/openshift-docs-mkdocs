...
## SPIFFE Helper container image { #zero-trust-manager-spiffe-helper-about_zero-trust-manager-spiffe-helper }
...
## SPIFFE Helper modes { #zero-trust-manager-spiffe-helper-modes_zero-trust-manager-spiffe-helper }
...
## SPIFFE Helper credential types { #zero-trust-manager-spiffe-helper-credential-types_zero-trust-manager-spiffe-helper }
...
## Deploying PostgreSQL with SPIFFE Helper { #zero-trust-manager-deploy-spiffe-helper_zero-trust-manager-spiffe-helper }
...
## SPIFFE Helper image reference { #zero-trust-manager-spiffe-helper-reference_zero-trust-manager-spiffe-helper }
...
### Image location { #zero-trust-manager-spiffe-helper-image-location_zero-trust-manager-spiffe-helper }
...
### Command-line flags { #zero-trust-manager-spiffe-helper-cli-flags_zero-trust-manager-spiffe-helper }
...
### Configuration file options { #zero-trust-manager-spiffe-helper-config-file-options_zero-trust-manager-spiffe-helper }
...
### Volume and mount requirements { #zero-trust-manager-spiffe-helper-vol-mount-reqs_zero-trust-manager-spiffe-helper }
...
### Quick reference { #zero-trust-manager-spiffe-helper-quick-reference_zero-trust-manager-spiffe-helper }
...
## Troubleshooting SPIFFE Helper deployments { #zero-trust-manager-spiffe-helper-troubleshooting_zero-trust-manager-spiffe-helper }
...
### Common issues { #zero-trust-manager-spiffe-helper-common-issues_zero-trust-manager-spiffe-helper }
...
<a name="zero-trust-manager-spiffe-helper-diagnostic-commands_zero-trust-manager-spiffe-helper"></a>

Use the following `oc` commands when investigating SPIFFE Helper deployments and workloads such as PostgreSQL.

### Verify Zero Trust Workload Identity Manager readiness { #zero-trust-manager-spiffe-helper-verify-readiness_zero-trust-manager-spiffe-helper }
...
### Inspect SPIFFE Helper pods { #zero-trust-manager-spiffe-helper-inspect-pods_zero-trust-manager-spiffe-helper }
...
### Review SPIFFE Helper logs { #zero-trust-manager-spiffe-helper-review-logs_zero-trust-manager-spiffe-helper }
...
### Verify on-disk SVID certificates { #zero-trust-manager-spiffe-helper-verify-svid-certificates_zero-trust-manager-spiffe-helper }
