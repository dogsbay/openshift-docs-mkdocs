---
title: Configuring the egress proxy for the Zero Trust Workload Identity Manager
---

# Configuring the egress proxy for the Zero Trust Workload Identity Manager { #zero-trust-manager-proxy_{context} }
...
## Injecting a custom CA certificate for the Zero Trust Workload Identity Manager { #zero-trust-manager-proxy-support_zero-trust-manager-proxy }
