...
## About the ZeroTrustWorkloadIdentityManager custom resource { #zero-trust-manager-ztwim-cr_zero-trust-manager-configuration }
...
## Deploying the SPIRE Server { #zero-trust-manager-spire-server-config_zero-trust-manager-configuration }
...
## Deploying the SPIRE Agent { #zero-trust-manager-spire-agent-config_zero-trust-manager-configuration }
...
## Deploying the SPIFFE Container Storage Interface driver { #zero-trust-manager-spire-csidriver-config_zero-trust-manager-configuration }
...
## Deploying the SPIRE OpenID Connect Discovery Provider { #zero-trust-manager-oidc-config_zero-trust-manager-configuration }
...
## Verify the health of the operands { #zero-trust-manager-verify-operands_zero-trust-manager-configuration }
...
## Manually delete the custom security context constraints { #zero-trust-manager-manually-delete-scc_zero-trust-manager-configuration }
