...
# Tang server installation considerations { #nbde-tang-server-installation-considerations }
...
## Installation scenarios { #nbde-installation-scenarios_nbde-implementation }
...
## Installing a Tang server { #nbde-installing-a-tang-server_nbde-implementation }
...
### Compute requirements { #nbde-compute-requirements_nbde-implementation }
...
### Automatic start at boot { #nbde-automatic-start-at-boot_nbde-implementation }
...
### HTTP versus HTTPS { #nbde-http-versus-https_nbde-implementation }
