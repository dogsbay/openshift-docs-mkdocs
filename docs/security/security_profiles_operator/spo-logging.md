...
## The Audit JSON log enricher { #spo-log-enrich_spo-audit-logging }
...
## Kubernetes API log compared to Advanced Audit Logging output { #spo-log-kube-api-compare_spo-audit-logging }
...
```yaml title="Kubernetes API Server Audit Log"
{
  "kind": "Event",
...
```yaml title="Advanced Audit Logging Output"
{
...
## Enabling Advanced Audit Logging { #spo-log-enabling_spo-audit-logging }
...
## Audit JSON Log Enricher configuration { #spo-log-json-enrich_spo-audit-logging }
...
## Audit log file fine-tuning and rotation { #spo-log-tune-rot_spo-audit-logging }
...
## Advanced audit logs for a specific pod { #spo-log-adv-pod_spo-audit-logging }
...
## Monitor the audit logs { #spo-log-mon-audit_spo-audit-logging }
...
## Audit node debugging sessions { #spo-log-debug_spo-audit-logging }
...
## Correlate with Kubernetes audit logs { #spo-log-correlate_spo-audit-logging }
...
## Audit JSON Log Enricher output { #spo-log-enrich-out_spo-audit-logging }
...
## Kubernetes API audit log output { #spo-log-kube-api-out_spo-audit-logging }
...
## Correlation key { #spo-log-corr-key_spo-audit-logging }
...
## Correlating with API Server Audit Log { #spo-log-corr-log_spo-audit-logging }
...
## Use the mutating webhook { #spo-log-webhook_spo-audit-logging }
...
### The debug pod { #debug-pod_spo-audit-logging }
...
## Disabling Advanced Audit Logging { #spo-log-disable_spo-audit-logging }
