...
- [Tutorial: Deploying an application by using the CLI](tutorials/dev-app-cli.md#dev-app-cli)
- [Tutorial: Deploying an application by using the web console](tutorials/dev-app-web-console.md#dev-app-web-console)
...
To review the Red Hat Developer learning paths, training courses, and cheat sheets for OpenShift Container Platform, see [Additional hands-on learning](tutorials/additional-tutorials.md#additional-tutorials).
