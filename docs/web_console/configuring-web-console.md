...
## Configuring the web console { #web-console-configuration_configuring-web-console }
...
## Disabling quick starts in the web console { #disable-quickstarts-admin-console_configuring-web-console }
...
3. On the **Configuration** page, click the **Console** configuration resource with the description **operator.openshift.io**. ![Image of the Configuration page showing the correct Console configuration resource to select](../images/cluster-settings-console.png)
