...
## Mirroring resources using the oc-mirror plugin { #mirroring-ocp-resources-ocmirror_mirroring-ocp-image-repository }
...
## Mirroring images using the oc adm release mirror command { #update-mirror-repository-adm-release-mirror_mirroring-ocp-image-repository }
...
### Preparing your mirror host { #updating-disconnected-mirror-host_mirroring-ocp-image-repository }

Before you perform the mirror procedure, you must prepare the host to retrieve content and push it to the remote location.

#### Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_mirroring-ocp-image-repository }
...
#### Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_mirroring-ocp-image-repository }
...
#### Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_mirroring-ocp-image-repository }
...
#### Configuring credentials that allow images to be mirrored { #installation-adding-registry-pull-secret_mirroring-ocp-image-repository }
...
### Mirroring images to a mirror registry { #update-mirroring-images-to-registry_mirroring-ocp-image-repository }
