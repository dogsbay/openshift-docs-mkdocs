...
## Prerequisites { #prerequisites_installing-mirroring-installation-images }
...
## About the mirror registry { #installation-about-mirror-registry_installing-mirroring-installation-images }
...
## Preparing your mirror host { #installing-preparing-mirror_installing-mirroring-installation-images }

Before you begin mirroring images, you must prepare the host to retrieve content and push it to the remote location.

### Installing the OpenShift CLI on Linux { #cli-installing-cli-linux_installing-mirroring-installation-images }
...
### Installing the OpenShift CLI on Windows { #cli-installing-cli-windows_installing-mirroring-installation-images }
...
### Installing the OpenShift CLI on macOS { #cli-installing-cli-macos_installing-mirroring-installation-images }
...
## Configuring credentials that allow images to be mirrored { #installation-adding-registry-pull-secret_installing-mirroring-installation-images }
...
## Mirroring the OpenShift Container Platform image repository { #installation-mirror-repository_installing-mirroring-installation-images }
...
## The Cluster Samples Operator in a disconnected environment { #installing-preparing-samples-operator_installing-mirroring-installation-images }
...
### Cluster Samples Operator assistance for mirroring { #installation-images-samples-disconnected-mirroring-assist_installing-mirroring-installation-images }
...
### Prerequisites for mirroring Operator catalogs { #olm-mirror-catalog-prerequisites_installing-mirroring-installation-images }
...
### Extracting and mirroring catalog contents { #olm-mirror-catalog-extracting_installing-mirroring-installation-images }
...
#### Mirroring catalog contents to registries on the same network { #olm-mirror-catalog-colocated_installing-mirroring-installation-images }
...
#### Mirroring catalog contents to airgapped registries { #olm-mirror-catalog-airgapped_installing-mirroring-installation-images }
...
### Generated manifests { #olm-mirror-catalog-manifests_installing-mirroring-installation-images }
...
### Postinstallation requirements { #olm-mirror-catalog-post_installing-mirroring-installation-images }
