...
## Encapsulating mount namespaces { #optimizing-cpu-usage_optimizing-cpu-usage }
...
![Before encapsulation](../../images/before-k8s-mount-propagation.png)
...
![After encapsulation](../../images/after-k8s-mount-propagation.png)
...
## Running additional services in the encapsulated namespace { #running-services-with-encapsulation_optimizing-cpu-usage }
...
- [MachineConfig](../../rest_api/machine_apis/machineconfig-machineconfiguration-openshift-io-v1.md)
