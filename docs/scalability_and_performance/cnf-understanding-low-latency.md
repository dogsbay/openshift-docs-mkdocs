...
## About low latency { #cnf-understanding-low-latency_cnf-understanding-low-latency }
...
## About Hyper-Threading for low latency and real-time applications { #cnf-about-hyper-threading-for-low-latency-and-real-time-applications_cnf-understanding-low-latency }
