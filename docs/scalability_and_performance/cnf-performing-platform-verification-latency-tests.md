...
### Example hwlatdetect test results { #cnf-performing-end-to-end-tests-example-results-hwlatdetect_cnf-latency-tests }
...
```terminal title="Example of good results"
...
```terminal title="Example of bad results"
hwlatdetect: test duration 3600 seconds
detector: tracer
...
### Example cyclictest results { #cnf-performing-end-to-end-tests-example-results-cyclictest_cnf-latency-tests }
...
### Mirroring the images to a custom registry accessible from the cluster { #cnf-performing-end-to-end-tests-mirroring-images-to-custom-registry_cnf-latency-tests }
...
### Configuring the tests to consume images from a custom registry { #cnf-performing-end-to-end-tests-image-parameters_cnf-latency-tests }
...
### Mirroring images to the cluster OpenShift image registry { #cnf-performing-end-to-end-tests-mirroring-to-cluster-internal-registry_cnf-latency-tests }
...
### Mirroring a different set of test images { #mirroring-different-set-of-images_cnf-latency-tests }
