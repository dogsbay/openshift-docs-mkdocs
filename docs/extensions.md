...
## OLM v1 highlights { #olmv1-highlights_extensions-overview }
...
## Purpose of Operator Lifecycle Manager { #olmv1-about-purpose_extensions-overview }
...
- [Operator Controller](extensions/arch/operator-controller.md#operator-controller)
- [Catalogd](extensions/arch/catalogd.md#catalogd)
- [Updating a cluster extension](extensions/ce/managing-ce.md#olmv1-updating-an-operator_managing-ce)
- [Installing extensions](extensions/ce/managing-ce.md#managing-ce)
