...
## Builds { #builds-about_understanding-image-builds }
...
### Docker build { #builds-strategy-docker-build_understanding-image-builds }
...
### Pipeline build { #builds-strategy-pipeline-build_understanding-image-builds }
