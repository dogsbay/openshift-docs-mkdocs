...
## Setting build resources { #builds-setting-build-resources_advanced-build-operations }
...
- Limit resource use by specifying resource limits as part of the build configuration.
    ...
    - In the following example, each of the `resources`, `cpu`, and `memory` parameters are optional:
        ...
        3. The `requests` object contains the list of resources that correspond to the list of resources in the quota.
...
## Setting maximum duration { #builds-setting-maximum-duration_advanced-build-operations }
...
## Chained builds { #builds-chaining-builds_advanced-build-operations }
...
## Pruning builds { #builds-build-pruning_advanced-build-operations }
...
## Build run policy { #builds-build-run-policy_advanced-build-operations }
