...
## OpenShift CLI (oc) developer commands { #openshift-cli-developer_cli-developer-commands }
...
### oc api-resources { #_oc_api-resources }
...
### oc api-versions { #_oc_api-versions }
...
### oc apply edit-last-applied { #_oc_apply_edit-last-applied }
...
### oc apply set-last-applied { #_oc_apply_set-last-applied }
...
### oc apply view-last-applied { #_oc_apply_view-last-applied }
...
### oc auth reconcile { #_oc_auth_reconcile }
...
### oc auth whoami { #_oc_auth_whoami }
...
### oc cancel-build { #_oc_cancel-build }
...
### oc cluster-info { #_oc_cluster-info }
...
### oc cluster-info dump { #_oc_cluster-info_dump }
...
### oc config current-context { #_oc_config_current-context }
...
### oc config delete-cluster { #_oc_config_delete-cluster }
...
### oc config delete-context { #_oc_config_delete-context }
...
### oc config delete-user { #_oc_config_delete-user }
...
### oc config get-clusters { #_oc_config_get-clusters }
...
### oc config get-contexts { #_oc_config_get-contexts }
...
### oc config get-users { #_oc_config_get-users }
...
### oc config new-admin-kubeconfig { #_oc_config_new-admin-kubeconfig }
...
### oc config new-kubelet-bootstrap-kubeconfig { #_oc_config_new-kubelet-bootstrap-kubeconfig }
...
### oc config refresh-ca-bundle { #_oc_config_refresh-ca-bundle }
...
### oc config rename-context { #_oc_config_rename-context }
...
### oc config set-cluster { #_oc_config_set-cluster }
...
### oc config set-context { #_oc_config_set-context }
...
### oc config set-credentials { #_oc_config_set-credentials }
...
### oc config unset { #_oc_config_unset }
...
### oc config use-context { #_oc_config_use-context }
...
### oc config view { #_oc_config_view }
...
### oc create build { #_oc_create_build }
...
### oc create clusterresourcequota { #_oc_create_clusterresourcequota }
...
### oc create clusterrole { #_oc_create_clusterrole }
...
### oc create clusterrolebinding { #_oc_create_clusterrolebinding }
...
### oc create configmap { #_oc_create_configmap }
...
### oc create cronjob { #_oc_create_cronjob }
...
### oc create deployment { #_oc_create_deployment }
...
### oc create deploymentconfig { #_oc_create_deploymentconfig }
...
### oc create identity { #_oc_create_identity }
...
### oc create imagestream { #_oc_create_imagestream }
...
### oc create imagestreamtag { #_oc_create_imagestreamtag }
...
### oc create ingress { #_oc_create_ingress }
...
### oc create namespace { #_oc_create_namespace }
...
### oc create poddisruptionbudget { #_oc_create_poddisruptionbudget }
...
### oc create priorityclass { #_oc_create_priorityclass }
...
### oc create quota { #_oc_create_quota }
...
### oc create role { #_oc_create_role }
...
### oc create rolebinding { #_oc_create_rolebinding }
...
### oc create route edge { #_oc_create_route_edge }
...
### oc create route passthrough { #_oc_create_route_passthrough }
...
### oc create route reencrypt { #_oc_create_route_reencrypt }
...
### oc create secret docker-registry { #_oc_create_secret_docker-registry }
...
### oc create secret generic { #_oc_create_secret_generic }
...
### oc create secret tls { #_oc_create_secret_tls }
...
### oc create service clusterip { #_oc_create_service_clusterip }
...
### oc create service externalname { #_oc_create_service_externalname }
...
### oc create service loadbalancer { #_oc_create_service_loadbalancer }
...
### oc create service nodeport { #_oc_create_service_nodeport }
...
### oc create serviceaccount { #_oc_create_serviceaccount }
...
### oc create token { #_oc_create_token }
...
### oc create user { #_oc_create_user }
...
### oc create useridentitymapping { #_oc_create_useridentitymapping }
...
### oc image append { #_oc_image_append }
...
### oc image extract { #_oc_image_extract }
...
### oc image mirror { #_oc_image_mirror }
...
### oc import-image { #_oc_import-image }
...
### oc new-project { #_oc_new-project }
...
### oc plugin list { #_oc_plugin_list }
...
### oc policy add-role-to-user { #_oc_policy_add-role-to-user }
...
### oc policy scc-review { #_oc_policy_scc-review }
...
### oc policy scc-subject-review { #_oc_policy_scc-subject-review }
...
### oc port-forward { #_oc_port-forward }
...
### oc registry login { #_oc_registry_login }
...
### oc rollout cancel { #_oc_rollout_cancel }
...
### oc rollout history { #_oc_rollout_history }
...
### oc rollout latest { #_oc_rollout_latest }
...
### oc rollout pause { #_oc_rollout_pause }
...
### oc rollout restart { #_oc_rollout_restart }
...
### oc rollout resume { #_oc_rollout_resume }
...
### oc rollout retry { #_oc_rollout_retry }
...
### oc rollout status { #_oc_rollout_status }
...
### oc rollout undo { #_oc_rollout_undo }
...
### oc secrets link { #_oc_secrets_link }
...
### oc secrets unlink { #_oc_secrets_unlink }
...
### oc set build-hook { #_oc_set_build-hook }
...
### oc set build-secret { #_oc_set_build-secret }
...
### oc set deployment-hook { #_oc_set_deployment-hook }
...
### oc set image-lookup { #_oc_set_image-lookup }
...
### oc set resources { #_oc_set_resources }
...
### oc set route-backends { #_oc_set_route-backends }
...
### oc set selector { #_oc_set_selector }
...
### oc set serviceaccount { #_oc_set_serviceaccount }
...
### oc set subject { #_oc_set_subject }
...
### oc set triggers { #_oc_set_triggers }
...
### oc set volumes { #_oc_set_volumes }
...
### oc start-build { #_oc_start-build }
