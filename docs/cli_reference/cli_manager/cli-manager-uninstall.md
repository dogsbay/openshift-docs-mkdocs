---
title: Uninstalling the CLI Manager Operator
---

# Uninstalling the CLI Manager Operator { #cli-manager-uninstall }
...
## Uninstalling the CLI Manager Operator { #cli-manager-uninstalling_cli-manager-uninstall }
...
2. Uninstall the CLI Manager Operator by completing the following steps:
    ...
    2. Click the Options menu ![](../../images/kebab.png "Options menu") next to the **CLI Manager Operator** entry and click **Uninstall Operator**.
...
2. Remove the `openshift-cli-manager-operator` namespace:
    ...
    2. Click the Options menu ![](../../images/kebab.png "Options menu") next to the **openshift-cli-manager-operator** entry and select **Delete Namespace**.
