...
## What problem is OADP VMFR solving { #oadp-vmfr-overview_virt-recovering-individual-files-from-vm-backups }
...
## When to use OADP VMFR { #oadp-vmfr-use-scenarios_virt-recovering-individual-files-from-vm-backups }
...
## OADP VMFR custom resources { #oadp-vmfr-custom-resources_virt-recovering-individual-files-from-vm-backups }
...
## How OADP VMFR works { #oadp-vmfr-how-it-works_virt-recovering-individual-files-from-vm-backups }
...
### Backup discovery phase { #_backup_discovery_phase }
...
### File restore phase { #_file_restore_phase }
...
### File-serving pod architecture { #_file-serving_pod_architecture }
...
## OADP VMFR prerequisites { #oadp-vmfr-prerequisites_virt-recovering-individual-files-from-vm-backups }
...
## OADP VMFR file access methods { #oadp-vmfr-access-methods_virt-recovering-individual-files-from-vm-backups }
...
### Web browser access { #oadp-vmfr-web-browser-access_virt-recovering-individual-files-from-vm-backups }
...
### SSH-based access { #_ssh-based_access }
...
## OADP VMFR limitations { #oadp-vmfr-limitations_virt-recovering-individual-files-from-vm-backups }
...
## OADP VMFR security considerations { #oadp-vmfr-security_virt-recovering-individual-files-from-vm-backups }
...
## OADP VMFR discovery and restore phases { #oadp-vmfr-phases_virt-recovering-individual-files-from-vm-backups }
