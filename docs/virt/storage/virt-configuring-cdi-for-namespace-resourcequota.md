...
## About CPU and memory quotas in a namespace { #virt-about-cpu-and-memory-quota-namespace_virt-configuring-cdi-for-namespace-resourcequota }
...
## Overriding CPU and memory defaults { #virt-overriding-cpu-and-memory-defaults_virt-configuring-cdi-for-namespace-resourcequota }
