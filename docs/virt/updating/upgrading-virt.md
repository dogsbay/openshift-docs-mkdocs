...
## About updating OpenShift Virtualization { #virt-about-upgrading-virt_upgrading-virt }
...
### Recommended settings { #recommended-settings_upgrading-virt }
...
### What to expect { #what-to-expect_upgrading-virt }
...
### How updates work { #how-updates-work_upgrading-virt }
...
### Changing update settings { #virt-changing-update-settings_upgrading-virt }
...
### Manual approval strategy { #virt-manual-approval-strategy_upgrading-virt }
...
### Approving a pending Operator update manually { #olm-approving-pending-upgrade_upgrading-virt }
...
## RHEL 9 compatibility { #virt-rhel-9_upgrading-virt }

OpenShift Virtualization 4.22 is based on Red Hat Enterprise Linux (RHEL) 9.

### RHEL 9 machine type { #rhel-9-machine-type_upgrading-virt }
...
## Monitoring update status { #virt-monitoring-upgrade-status_upgrading-virt }
...
## VM workload updates { #virt-about-workload-updates_upgrading-virt }
...
### Migration attempts and timeouts { #migration-attempts-timeouts_upgrading-virt }
...
### Configuring workload update methods { #virt-configuring-workload-update-methods_upgrading-virt }
...
### Viewing outdated VM workloads { #virt-viewing-outdated-workloads_upgrading-virt }
...
## Control Plane Only updates { #virt-about-control-plane-only-updates_upgrading-virt }
...
### Preventing workload updates during a Control Plane Only update { #virt-preventing-workload-updates-during-control-plane-only-update_upgrading-virt }
...
## Early access releases { #virt-early-access-releases_upgrading-virt }
