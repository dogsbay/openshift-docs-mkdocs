...
## Creating a user-defined-network for localnet topology by using the CLI { #virt-creating-secondary-localnet-udn_virt-connecting-vm-to-secondary-udn }
...
## Creating a namespace for secondary user-defined networks by using the CLI { #virt-creating-secondary-udn-namespace_virt-connecting-vm-to-secondary-udn }
...
## Attaching a virtual machine to secondary user-defined networks by using the CLI { #virt-attaching-vm-to-secondary-udn_virt-connecting-vm-to-secondary-udn }
...
## Considerations when running OpenShift Virtualization on IBM Z(R) { #virt-udn-considerations-ibm-z_virt-connecting-vm-to-secondary-udn }
...
## Configuring a RoCE adapter for virtual machine networking on IBM Z(R) { #virt-udn-roce-ibm-z_virt-connecting-vm-to-secondary-udn }
...
## Configuring OSA and HiperSockets adapters for virtual machine networking on IBM Z(R) { #virt-udn-osa-hipersockets-ibm-z_virt-connecting-vm-to-secondary-udn }
...
4. Or, enable MAC address learning by using `chzdev`:
    ...
    `chzdev`
    :   Specifies the tool to configure IBM Z(R) devices.
