...
## What huge pages do { #what-huge-pages-do_virt-using-huge-pages-with-vms }
...
## Configuring huge pages for virtual machines { #virt-configuring-huge-pages-for-vms_virt-using-huge-pages-with-vms }
