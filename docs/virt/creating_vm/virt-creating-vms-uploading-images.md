...
5. Click the Options menu ![](../../images/kebab.png "Options menu") and select **Control** → **Start**.
...
4. Click the Options menu ![](../../images/kebab.png "Options menu") beside the `sysprep` disk and select **Detach**.
