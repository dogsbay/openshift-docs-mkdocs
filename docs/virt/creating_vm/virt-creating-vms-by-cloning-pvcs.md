...
## About cloning { #virt-about-cloning_virt-creating-vms-by-cloning-pvcs }
...
### CSI volume cloning { #csi-volume-cloning_virt-creating-vms-by-cloning-pvcs }
...
### Smart cloning { #smart-cloning_virt-creating-vms-by-cloning-pvcs }
...
### Host-assisted cloning { #host-assisted-cloning_virt-creating-vms-by-cloning-pvcs }
...
## Creating a VM from a PVC by using the web console { #virt-creating-vm-custom-image-web_virt-creating-vms-by-cloning-pvcs }
...
## Creating a VM from a PVC by using the CLI { #virt-creating-vm-by-cloning-pvcs-cli_virt-creating-vms-by-cloning-pvcs }
...
### Optimizing clone Performance at scale in OpenShift Data Foundation { #virt-optimizing-clone-performance-at-scale-in-openshift-data-foundation_virt-creating-vms-by-cloning-pvcs }
...
### Cloning a PVC to a data volume { #virt-cloning-pvc-to-dv-cli_virt-creating-vms-by-cloning-pvcs }
...
### Creating a VM from a cloned PVC by using a data volume template { #virt-creating-vm-cloning-pvc-data-volume-template_virt-creating-vms-by-cloning-pvcs }
