...
## AI safety { #ai-app-mcp-server-ai-safety_mcp-server-overview }
...
### Data ownership { #ai-app-mcp-server-ai-safety-data-ownership_mcp-server-overview }
...
### Required verification workflow: Human in the loop (HITL) enforcement { #ai-app-mcp-server-ai-safety-hitl_mcp-server-overview }
...
### Data privacy and redaction { #ai-app-mcp-server-ai-safety-privacy-redaction_mcp-server-overview }
...
### Audit trail recommendation { #ai-app-mcp-server-ai-safety-audit-trail_mcp-server-overview }
...
### Recommendations regarding 3rd-party MCP servers { #ai-app-mcp-server-ai-safety-mcp-servers-hitl_mcp-server-overview }
...
### AI governance and guardrails { #ai-app-mcp-server-ai-safety-governance-guardrails_mcp-server-overview }
...
### Emergency removal of AI agent access { #ai-app-mcp-server-ai-safety-governance-removal_mcp-server-overview }
...
## Model Context Protocol overview { #ai-app-mcp-server-model-context-protocol-overview_mcp-server-overview }
...
## MCP server overview { #ai-app-mcp-server-mcp-server-overview_mcp-server-overview }
...
### The Goals of an MCP server { #ai-app-mcp-server-mcp-server-overview-goals_mcp-server-overview }
...
## MCP gateway overview { #ai-app-mcp-server-mcp-gateway-overview_mcp-server-overview }
...
### Aggregation and orchestration { #ai-app-mcp-server-mcp-gateway-overview-agg-orch_mcp-server-overview }
...
### Security and access control { #ai-app-mcp-server-mcp-gateway-overview-security-access_mcp-server-overview }
...
### Protocol translation { #ai-app-mcp-server-mcp-gateway-overview-protocol_mcp-server-overview }
...
### Scalability { #ai-app-mcp-server-mcp-gateway-overview-scale_mcp-server-overview }
...
## MCP server for Red Hat OpenShift Prompting workflow { #ai-app-mcp-server-model-context-prompting-workflow_mcp-server-overview }
...
## Install MCP server for Red Hat OpenShift { #ai-mcp-server-install_mcp-server-overview }
...
### Install the MCP server Helm chart { #ai-app-mcp-server-install-helm_mcp-server-overview }
...
### Connect a client to the MCP server { #ai-app-mcp-server-connect-client_mcp-server-overview }
...
### Install the MCP gateway { #ai-app-mcp-server-install-gateway_mcp-server-overview }
...
### Verify the MCP gateway deployment { #ai-app-mcp-server-verify-deployment_mcp-server-overview }
...
### Configure the MCP gateway { #ai-app-mcp-server-configure-gateway_mcp-server-overview }
...
### Configure RBAC enforcement { #ai-app-mcp-server-configure-rbac_mcp-server-overview }
...
1. Configure RBAC enforcement by extending ClusterRoles, ClusterRoleBindings, Roles, and Rolebindings.
    ...
    ```yaml title="Example RBAC settings YAML file"
    extraClusterRoles:
...
### Revoke access to Custom Resources { #ai-app-mcp-server-revoke-cr-access_mcp-server-overview }
...
### Set up MCP gateway authentication { #ai-app-mcp-server-setup-authentication_mcp-server-overview }
...
### Set up MCP gateway authorization { #ai-app-mcp-server-setup-authorization_mcp-server-overview }
...
## MCP server for Red Hat OpenShift prompting { #ai-app-mcp-server-overview-prompting-instructions_mcp-server-overview }
...
### MCP prompts { #ai-app-mcp-server-overview-prompting-instructions-prompts_mcp-server-overview }
...
### Creating custom prompts { #ai-app-mcp-server-overview-prompting-instructions-custom_mcp-server-overview }
...
### Built-in prompts { #ai-app-mcp-server-overview-prompting-instructions-built-in_mcp-server-overview }
...
### Configuration file location { #ai-app-mcp-server-overview-prompting-instructions-config-file_mcp-server-overview }
...
### Toolset prompts { #ai-app-mcp-server-overview-prompting-instructions-toolset_mcp-server-overview }

Some toolsets contain prompts and enabling the toolset enables the prompt(s).

### Prompt merging { #ai-app-mcp-server-overview-prompting-instructions-merging_mcp-server-overview }
