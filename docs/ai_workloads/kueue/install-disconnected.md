...
## Compatible environments { #compatible-environments_install-disconnected }

Your cluster must meet specific architecture and platform requirements before you can install Red Hat build of Kueue.

### Supported architectures { #compatible-environments-arch_install-disconnected }
...
### Supported platforms { #compatible-environments-platforms_install-disconnected }
...
## Installing the Red Hat Build of Kueue Operator { #install-kueue-operator_install-disconnected }
...
## Upgrading Red Hat build of Kueue { #upgrading-kueue_install-disconnected }
...
## Creating a Kueue custom resource { #create-kueue-cr_install-disconnected }
...
## Labeling namespaces to allow Red Hat build of Kueue to manage jobs { #label-namespaces_install-disconnected }
