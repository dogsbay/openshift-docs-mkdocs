...
## Uninstalling the JobSet Operator { #js-uninstall_js-uninstall }
...
4. Delete the `JobSetOperator` instance.
    ...
    2. Click the Options menu ![](../../images/kebab.png "Options menu") next to the **cluster** entry and select **Delete JobSetOperator**.
    3. In the confirmation dialog, click **Delete**.

5. Uninstall the JobSet Operator.

    1. Navigate to **Operators** → **Installed Operators**.
    2. Click the Options menu ![](../../images/kebab.png "Options menu") next to the **JobSet Operator** entry and click **Uninstall Operator**.
...
2. Remove CRDs that were created when the JobSet Operator was installed:
    ...
    3. Click the Options menu ![](../../images/kebab.png "Options menu") next to the **JobSetOperator** CRD and select **Delete CustomResourceDefinition**.
...
3. Delete the `openshift-jobset-operator` namespace.
    ...
    3. Click the Options menu ![](../../images/kebab.png "Options menu") next to the **openshift-jobset-operator** entry and select **Delete Namespace**.
