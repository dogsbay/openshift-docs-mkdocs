...
## About the Node Feature Discovery Operator { #_about_the_node_feature_discovery_operator }
...
### Creating a NodeFeatureDiscovery CR by using the CLI in a disconnected environment { #creating-nfd-cr-cli-disconnected_psap-node-feature-discovery-operator }
...
## NFD core configuration parameters { #nfd-configuring-core_psap-node-feature-discovery-operator }
...
## NFD core klog configuration parameters { #nfd-configuring-core-klog_psap-node-feature-discovery-operator }
...
## NFD sources configuration parameters { #nfd-configuring-sources_psap-node-feature-discovery-operator }
...
## Configure Node Feature Discovery worker and controller pod scheduling { #configuring-nfd-worker-master-pod-scheduling_psap-node-feature-discovery-operator }
...
## About the NodeFeatureRule custom resource { #nfd-rules-about_psap-node-feature-discovery-operator }
...
## Using the NodeFeatureRule custom resource { #nfd-rules-using_psap-node-feature-discovery-operator }
...
### NFD Topology Updater command-line flags { #nfd-topology-updater-command-line-flags_psap-node-feature-discovery-operator }
