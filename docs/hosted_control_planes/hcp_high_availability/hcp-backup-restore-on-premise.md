...
## Backing up etcd on a hosted cluster { #hosted-cluster-etcd-backup-restore-on-premise_hcp-backup-restore-on-premise }
...
## Restoring etcd on a hosted cluster { #hosted-cluster-etcd-restore-on-premise_hcp-backup-restore-on-premise }
