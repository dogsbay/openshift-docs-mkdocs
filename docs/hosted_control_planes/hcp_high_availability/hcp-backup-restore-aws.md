...
## Taking a snapshot of etcd for a hosted cluster { #backup-etcd-hosted-cluster_hcp-backup-restore-aws }
...
## Restoring an etcd snapshot on a hosted cluster { #restoring-etcd-snapshot-hosted-cluster_hcp-backup-restore-aws }
