...
## Accessing the hosted cluster { #hcp-bm-access_hcp-manage-bm }
...
## Scaling the NodePool object for a hosted cluster { #hcp-bm-scale-np_hcp-manage-bm }
...
### Adding node pools { #hcp-bm-add-np_hcp-manage-bm }
...
### Enabling node auto-scaling for the hosted cluster { #hcp-bm-autoscale_hcp-manage-bm }
...
### Disabling node auto-scaling for the hosted cluster { #hcp-bm-autoscale-disable_hcp-manage-bm }
...
## Enabling machine health checks on bare metal { #hcp-bm-machine-health_hcp-manage-bm }
...
## Disabling machine health checks on bare metal { #hcp-bm-machine-health-disable_hcp-manage-bm }
