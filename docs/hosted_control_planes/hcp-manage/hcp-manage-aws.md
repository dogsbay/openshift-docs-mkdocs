...
## Prerequisites to manage AWS infrastructure and IAM permissions { #hcp-manage-aws-prereq_hcp-managing-aws }
...
### Infrastructure requirements for AWS { #hcp-manage-aws-infra-req_hcp-managing-aws }
...
### Unmanaged infrastructure for the HyperShift Operator in an AWS account { #hcp-manage-aws-infra-ho-req_hcp-managing-aws }
...
### Unmanaged infrastructure requirements for a management AWS account { #hcp-unmanaged-aws-hc-prereq_hcp-managing-aws }
...
### Infrastructure requirements for an AWS account in a hosted cluster { #hcp-managed-aws-infra-hc_hcp-managing-aws }
...
### Kubernetes-managed infrastructure in a hosted cluster AWS account { #hcp-k8s-managed-aws-infra-hc_hcp-managing-aws }
...
## Identity and Access Management (IAM) permissions for hosted control planes on AWS { #hcp-managed-aws-iam_hcp-managing-aws }
...
## Separate creation of the hosted cluster and its resources { #hcp-managed-aws-infra-iam-separate_hcp-managing-aws }
...
### Creating the AWS infrastructure separately { #hcp-managed-aws-infra-separate_hcp-managing-aws }
...
### Creating a hosted cluster separately { #hcp-managed-aws-hc-separate_hcp-managing-aws }
...
## Transitioning a hosted cluster from single-architecture to multi-architecture { #hcp-migrate-aws-single-to-multiarch_hcp-managing-aws }
...
## Creating node pools on the multi-architecture hosted cluster { #hcp-migrate-aws-multiarch-nodepools_hcp-managing-aws }
...
## Adding or updating AWS tags for a hosted cluster { #hcp-aws-tags_hcp-managing-aws }
...
## Configuring node pool capacity blocks on AWS { #hcp-np-capacity-blocks_hcp-managing-aws }
...
### Deleting a hosted cluster after configuring node pool capacity blocks { #hcp-np-capacity-blocks-destroy_hcp-managing-aws }
...
## Amazon Spot Instance support for node pools { #hcp-aws-spot-instance_hcp-managing-aws }
...
### Configuring Amazon SQS and Amazon EventBridge to receive Amazon EC2 interruption events { #hcp-aws-config-sqs-eventbridge_hcp-managing-aws }
...
### Enabling Amazon Spot Instance support for node pools { #hcp-aws-spot-instance-enable_hcp-managing-aws }
