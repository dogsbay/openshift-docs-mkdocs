...
## Requirements to upgrade hosted control planes { #hosted-control-planes-upgrading-requirements_hcp-updating }
...
## Hosted cluster and node pool version skew policy { #hcp-np-version-skew_hcp-updating }
...
## Setting update channels in a hosted cluster { #hcp-get-ocp-channel_hcp-updating }
...
## Updates of the OpenShift Container Platform version in a hosted cluster { #hcp-get-upgrade-versions_hcp-updating }
...
### The multicluster engine Operator hub management cluster { #hcp-mce-hub-cluster_hcp-updating }
...
### Supported OpenShift Container Platform versions in a hosted cluster { #hcp-supported-ocp-versions_hcp-updating }
...
## Updates for the hosted cluster { #hcp-updates-hosted-cluster_hcp-updating }
...
## Updates for node pools { #hcp-updates-node-pools_hcp-updating }
...
### Replace updates for node pools { #hcp-updates-node-pools-replace_hcp-updating }
...
### In place updates for node pools { #hcp-updates-node-pools-inplace_hcp-updating }
...
## Updating node pools in a hosted cluster { #hcp-update-node-pools_hcp-updating }
...
## Updating a control plane in a hosted cluster { #hcp-update-ocp-hc_hcp-updating }
...
## Updating a hosted cluster by using the multicluster engine Operator console { #hcp-update-using-mce-console_hcp-updating }
