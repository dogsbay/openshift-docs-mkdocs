...
## Scaling down the data plane to zero { #scale-down-data-plane_hcp-machine-config }
...
## Autoscaling to and from zero on hosted control planes node pools { #hcp-autoscaling-to-from-zero_hcp-machine-config }
...
### Terminology { #hcp-autoscaling-terminology_hcp-machine-config }
...
### Use cases for scale-to-zero autoscaling { #hcp-scale-to-zero-use-cases_hcp-machine-config }
...
### Best practices for scale-to-zero autoscaling { #hcp-scale-to-zero-best-practices_hcp-machine-config }
...
### Configuring autoscaling to and from zero on hosted control planes node pools { #hcp-autoscaling-to-from-zero-configure_hcp-machine-config }
...
### NodePool autoscaling configuration reference { #hcp-autoscaling-nodepool-reference_hcp-machine-config }
...
### NodePool API reference for autoscaling { #hcp-nodepool-api-reference_hcp-machine-config }
...
#### spec.autoScaling { #hcp-nodepool-api-spec-autoscaling_hcp-machine-config }
...
#### spec.replicas { #hcp-nodepool-api-spec-replicas_hcp-machine-config }

| Field      | Type    | Description                                                                                         |
| ---------- | ------- | --------------------------------------------------------------------------------------------------- |
| `replicas` | integer | Fixed number of nodes when autoscaling is disabled. Omit this field when `spec.autoScaling` is set. |

#### Drain and detach timeouts { #hcp-nodepool-api-drain-detach-timeouts_hcp-machine-config }
...
#### status.conditions { #hcp-nodepool-api-status-conditions_hcp-machine-config }

| Condition            | Description                                                                                  |
| -------------------- | -------------------------------------------------------------------------------------------- |
| `AutoscalingEnabled` | Reports `True` when autoscaling is correctly configured and the autoscaler manages the pool. |

#### HyperShift Operator flags { #hcp-nodepool-api-sm-operator-flags_hcp-machine-config }
