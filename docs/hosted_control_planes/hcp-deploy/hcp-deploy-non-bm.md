---
title: Deploying hosted control planes on non-bare-metal agent machines
---

# Deploying hosted control planes on non-bare-metal agent machines { #hcp-deploy-non-bm }
...
## Preparing to deploy hosted control planes on non-bare-metal agent machines { #hcp-non-bm-prepare_hcp-deploy-non-bm }
...
### Prerequisites for deploying hosted control planes on non-bare-metal agent machines { #hcp-non-bm-prereqs_hcp-deploy-non-bm }
...
### Firewall, port, and service requirements for non-bare-metal agent machines { #hcp-non-bm-firewall-port-svc-reqs_hcp-deploy-non-bm }
...
### Infrastructure requirements for non-bare-metal agent machines { #hcp-non-bm-infra-reqs_hcp-deploy-non-bm }
...
## DNS configuration on non-bare-metal agent machines { #hcp-non-bm-dns_hcp-deploy-non-bm }
...
```text title="Example DNS configuration for a connected environment on an IPv4 network"
...
```text title="Example DNS configuration for a disconnected environment on an IPv6 network"
...
```text title="Example DNS configuration for a disconnected environment on a dual stack network"
...
## Defining a custom DNS name { #hcp-custom-dns_hcp-deploy-non-bm }
...
## Creating a hosted cluster on non-bare-metal agent machines by using the CLI { #hcp-non-bm-hc_hcp-deploy-non-bm }
...
## Creating a hosted cluster on non-bare-metal agent machines by using the web console { #hcp-non-bm-hc-console_hcp-deploy-non-bm }
...
## Creating a hosted cluster on non-bare-metal agent machines by using a mirror registry { #hcp-non-bm-hc-mirror_hcp-deploy-non-bm }
...
## Capabilities for hosted clusters { #hcp-cluster-capabilities_hcp-deploy-non-bm }
...
### Capabilities that you can enable or disable for a hosted cluster { #hcp-cluster-capabilities-ref_hcp-deploy-non-bm }
...
### Setting capabilities for a hosted cluster { #hcp-cluster-capabilities-proc_hcp-deploy-non-bm }
...
## Verifying hosted cluster creation on non-bare-metal agent machines { #hcp-non-bm-verify_hcp-deploy-non-bm }
