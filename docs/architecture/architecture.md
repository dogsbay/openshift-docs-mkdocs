...
## Introduction to OpenShift Container Platform { #architecture-platform-introduction_architecture }
...
![Red Hat OpenShift Kubernetes Engine](../images/525-OpenShift-arch-012025.png)
...
### The benefits of containerized applications { #architecture-container-application-benefits_architecture }
...
### OpenShift Container Platform overview { #architecture-platform-benefits_architecture }
...
:   The following figure illustrates the basic OpenShift Container Platform lifecycle:
    ...
    **Figure 1. High-level OpenShift Container Platform overview**
    ...
    ![High-level OpenShift Container Platform flow](../images/ocp_arch_lifecycle.png)
