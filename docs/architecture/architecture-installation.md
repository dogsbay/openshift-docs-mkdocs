...
# Installation and update { #architecture-installation }
...
## The OpenShift Container Platform installation { #installation-overview_architecture-installation }
...
### The installation program { #about-the-installation-program_architecture-installation }
...
![OpenShift Container Platform installation targets and dependencies](../images/targets-and-dependencies.png)
...
### Supported platforms for OpenShift Container Platform clusters { #supported-platforms-for-openshift-clusters_architecture-installation }
...
### Installation process { #installation-process_architecture-installation }
...
### Installation process details { #installation-process-details_architecture-installation }
...
## About the OpenShift Update Service { #update-service-about_architecture-installation }
...
## Support policy for unmanaged Operators { #unmanaged-operators_architecture-installation }
...
- [Selecting a cluster installation method and preparing it for users](../installing/overview/installing-preparing.md#installing-preparing)
