...
## Containerized application development { #developing-containerized-applications_understanding-development }
...
## Simple container build process { #building-simple-container_understanding-development }
...
- [Custom image builds with Buildah](../cicd/builds/custom-builds-buildah.md#custom-builds-buildah)
...
### Base image options { #base-image-options_understanding-development }
...
![OpenShift Container Platform Developer Catalog](../images/developer-catalog.png)
...
### Registry options { #understanding-development-registry-options_understanding-development }
...
### Kubernetes manifest components for OpenShift Container Platform { #creating-kubernetes-manifest-openshift_understanding-development }
...
### Kubernetes pods and services { #understanding-kubernetes-pods_understanding-development }
...
- [`DeploymentConfig` (Kubernetes documentation)](../applications/deployments/what-deployments-are.md#what-deployments-are)

### Application types { #application-types_understanding-development }
...
- [Deployment (Kubernetes documentation)](../applications/deployments/what-deployments-are.md#deployments-kube-deployments)
...
### Available supporting components { #supporting-components_understanding-development }
...
### Manifest application { #applying-manifest_understanding-development }
...
## Operators development { #develop-for-operators_understanding-development }
