...
- [Understanding configuration drift detection](../machine_configuration.md#machine-config-drift-detection_machine-config-overview)

## Machine roles in OpenShift Container Platform { #architecture-machine-roles_control-plane }
...
## Operators in OpenShift Container Platform { #operators-overview_control-plane }
...
### Cluster Operators { #cluster-operators_control-plane }
...
### Add-on Operators { #olm-operators_control-plane }
...
## etcd key-value store { #etcd-overview_control-plane }
