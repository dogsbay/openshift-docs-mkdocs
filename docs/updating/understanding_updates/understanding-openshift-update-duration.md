...
## Factors affecting update duration { #factors-affecting-update-duration_openshift-update-duration }
...
## Cluster update phases { #cluster-update-phases_openshift-update-duration }
...
### Cluster Version Operator target update payload deployment { #cluster-version-operator_openshift-update-duration }
...
### Machine Config Operator node updates { #machine-config-operator-node-updates_openshift-update-duration }
...
### Example update duration of cluster Operators { #update-duration-example_openshift-update-duration }
...
![A diagram displaying the periods during which cluster Operators update themselves during an OpenShift Container Platform update](../../images/362_OpenShift_update_duration_0526.png)
...
## How to estimate cluster update time { #estimating-cluster-update-time_openshift-update-duration }
