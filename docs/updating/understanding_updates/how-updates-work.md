...
![A diagram displaying the sequence of Runlevels and the manifests of components within each level](../../images/341_OpenShift_CVO_manifests_0526.png)
