...
### Restricted network installation with initial network access { #samples-operator-restricted-nw-install-with-access_configuring-samples-operator }
...
## Cluster Samples Operator tracking and error recovery of image stream imports { #samples-operator-retries_configuring-samples-operator }
...
### Cluster Samples Operator assistance for mirroring { #installation-images-samples-disconnected-mirroring-assist_configuring-samples-operator }
...
## Cluster Samples Operator configuration parameters { #samples-operator-configuration_configuring-samples-operator }
...
### Configuration restrictions { #samples-operator-config-restrictions_configuring-samples-operator }
...
### Samples resource conditions { #samples-operator-conditions_configuring-samples-operator }
...
<tr>
  ...
  <td><code>True</code> when the Cluster Samples Operator detects that the version is different from the Cluster Samples Operator version with which the current samples set are installed.<br><br>This condition is deprecated in OpenShift Container Platform.</td>
</tr>
</tbody>
</table>
