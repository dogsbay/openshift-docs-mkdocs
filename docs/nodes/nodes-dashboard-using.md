...
## About the node metrics dashboard { #nodes-dashboard-using-about_nodes-dashboard-using }
...
## Identify metrics for indicating optimal node resource usage { #nodes-dashboard-using-identify_nodes-dashboard-using }
...
### Top 3 containers with the most OOM kills in the last day { #nodes-dashboard-using-identify-critical-top3_nodes-dashboard-using }
...
```text title="Example default query"
...
### Failure rate for image pulls in the last hour { #nodes-dashboard-using-identify-critical-pulls_nodes-dashboard-using }
...
### Nodes with system reserved memory utilization > 80% { #nodes-dashboard-using-identify-critical-memory_nodes-dashboard-using }
...
### Nodes with Kubelet system reserved memory utilization > 50% { #nodes-dashboard-using-identify-critical-memory-kubelet_nodes-dashboard-using }
...
### Nodes with CRI-O system reserved memory utilization > 50% { #nodes-dashboard-using-identify-critical-memory-crio_nodes-dashboard-using }
...
### Nodes with System Reserved CPU Utilization > 80% { #nodes-dashboard-using-identify-critical-cpu }
...
### Nodes with Kubelet system reserved CPU utilization > 50% { #nodes-dashboard-using-identify-critical-cpu-kubelet_nodes-dashboard-using }
...
### Nodes with CRI-O system reserved CPU utilization > 50% { #nodes-dashboard-using-identify-critical-cpu-crio }
...
## Customizing dashboard queries { #nodes-dashboard-using-queries_nodes-dashboard-using }
