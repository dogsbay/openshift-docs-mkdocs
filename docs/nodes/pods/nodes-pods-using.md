...
## Understanding pods { #nodes-pods-using-about_nodes-pods-using-ssy }
...
## Example pod configurations { #nodes-pods-using-example_nodes-pods-using-ssy }
...
<a name="example-pod-definition_nodes-pods-using-ssy"></a>

```yaml title="Pod object definition (YAML)"
kind: Pod
apiVersion: v1
metadata:
  name: example
...
## Understanding resource requests and limits { #nodes-pods-understanding-requests-limits_nodes-pods-using-ssy }
