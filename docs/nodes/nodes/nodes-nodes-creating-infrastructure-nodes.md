...
## OpenShift Container Platform infrastructure components { #infrastructure-components_creating-infrastructure-nodes }
...
### Creating an infrastructure node { #creating-an-infra-node_creating-infrastructure-nodes }
