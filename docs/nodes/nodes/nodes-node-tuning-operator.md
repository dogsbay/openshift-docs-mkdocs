...
## Node Tuning Operator { #about-node-tuning-operator_nodes-node-tuning-operator }
...
## Custom tuning specification { #custom-tuning-specification_nodes-node-tuning-operator }
...
## Default profiles set on a cluster { #custom-tuning-default-profiles-set_nodes-node-tuning-operator }
...
## Supported TuneD daemon plugins { #supported-tuned-daemon-plug-ins_nodes-node-tuning-operator }
